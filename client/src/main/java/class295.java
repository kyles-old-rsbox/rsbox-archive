   ...
   public static class412 method5542() {
      synchronized(class412.field4560) {
         if (class412.field4562 == 0) {
            ...
            class412.field4560[--class412.field4562].method7413();
                  ...
                  if (client.field1802 == 1) {
                     ...
                     if (null != var8) {
                        for(var13 = 4; var13 >= 0; --var13) {
                           if (var0.method1639(var13) && var8[var13] != null && !var8[var13].equalsIgnoreCase(class338.field4056)) {
                              var10 = 0;
                              if (0 == var13) {
                                 var10 = 9 + var7;
                              }
                              ...
                              client.method351(var8[var13], class96.method4510(16776960) + var6, var10, var1, var2, var3);
                           }
                        }
                     }
                     ...
                     if (var8 != null) {
                        for(var13 = 4; var13 >= 0; --var13) {
                           if (var0.method1639(var13) && null != var8[var13] && var8[var13].equalsIgnoreCase(class338.field4056)) {
                              short var12 = 0;
