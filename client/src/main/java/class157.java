public class class157 extends class175 {
   ...
   int field1435 = 0;
   int field1438 = 256;
   long field1434 = class272.method2046();
   long[] field1436 = new long[10];
   ...
   static final boolean method2603(class300 var0) {
      ...
      if (var2 == 205) {
         ...
         if (var2 >= 300 && var2 <= 313) {
            var3 = (var2 - 300) / 2;
            var4 = var2 & 1;
            client.field1920.method5992(var3, 1 == var4);
         }

         if (var2 >= 314 && var2 <= 323) {
            var3 = (var2 - 314) / 2;
            var4 = var2 & 1;
            client.field1920.method6004(var3, 1 == var4);
         }

         if (var2 == 324) {
            client.field1920.method5991(0);
         }

         if (325 == var2) {
            client.field1920.method5991(1);
         }

         if (var2 == 326) {
            class263 var5 = class185.method3435(class274.field3065, client.field1778.field1071);
            client.field1920.method6008(var5.field2984);
