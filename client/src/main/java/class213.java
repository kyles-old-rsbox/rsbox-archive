public class class213 {
   ...
   public static class193 method4120(int var0) {
      ...
      if (var2 != null) {
         ...
         byte[] var3 = class19.field97.method6167(11, var0);
         var2 = new class193();
         if (var3 != null) {
            var2.method3553(new class460(var3));
         }
   ...
   static class459 method4118(int var0) {
      ...
      if (var2 == null) {
         var2 = new class459(class255.field2944, class444.method7135(var0), class444.method6191(var0));
