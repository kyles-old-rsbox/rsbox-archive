...
public class class9 {
   ...
   static final void method56(class453 var0) {
      for(int var2 = 0; var2 < class102.field1007; ++var2) {
         ...
         int var5 = var0.method8134();
         if (0 != (var5 & 4)) {
            var5 += var0.method8134() << 8;
         }

         byte var6 = class197.field2119.field2117;
         int var7;
         if (0 != (var5 & 16)) {
            var4.field835 = var0.method8157();
            if (class78.field683) {
               var4.field835 += var0.method8334() << 16;
               var7 = 16777215;
            } else {
               var7 = 65535;
            }
         ...
         if (0 != (var5 & 2)) {
            var4.field822 = var0.method8124();
            if (var4.field822.charAt(0) == '~') {
               var4.field822 = var4.field822.substring(1);
               class42.method773(2, var4.field910.method8444(), var4.field822);
         ...
         if ((var5 & 64) != 0) {
            var7 = var0.method8147();
            byte[] var8 = new byte[var7];
            class460 var9 = new class460(var8);
            var0.method8326(var8, 0, var7);
            class102.field1011[var3] = var9;
            var4.method1906(var9);
         }

         if ((var5 & 4096) != 0) {
            var6 = var0.method8280();
         }

         int var15;
         if (0 != (var5 & 8)) {
            var7 = var0.method8195();
            if (65535 == var7) {
               var7 = -1;
            }

            var15 = var0.method8146();
            class442.method7914(var4, var7, var15);
         }

         if (0 != (var5 & 2048)) {
            var4.field862 = client.field1645 + var0.method8155();
            var4.field863 = client.field1645 + var0.method8157();
            var4.field864 = var0.method8280();
            var4.field865 = var0.method8328();
            var4.field850 = var0.method8280();
            var4.field867 = (byte)var0.method8334();
         }

         if ((var5 & 1) != 0) {
            var4.field868 = var0.method8115();
            if (0 == var4.field871) {
         ...
         if (0 != (var5 & 16384)) {
            var4.field815 = var0.method8180();
            var4.field855 = var0.method8328();
            var4.field854 = var0.method8328();
            var4.field853 = var0.method8180();
            var4.field857 = var0.method8157() + client.field1645;
            var4.field858 = var0.method8155() + client.field1645;
            var4.field859 = var0.method8115();
            if (var4.field919) {
         ...
         if (0 != (var5 & 32)) {
            ...
            if (var7 > 0) {
               for(var15 = 0; var15 < var7; ++var15) {
                  ...
                  var11 = -1;
                  var12 = -1;
                  var16 = var0.method8200();
                  if (32767 == var16) {
                     var16 = var0.method8200();
                     var11 = var0.method8200();
                     var10 = var0.method8200();
                     var12 = var0.method8200();
                  } else if (var16 != 32766) {
                     var11 = var0.method8200();
                  } else {
                     var16 = -1;
            ...
            if (var15 > 0) {
               for(var16 = 0; var16 < var15; ++var16) {
                  ...
                  if (32767 != var11) {
                     var12 = var0.method8200();
                     var13 = var0.method8334();
                     var14 = var11 > 0 ? var0.method8134() : var13;
         ...
         if (0 != (var5 & 8192)) {
            var4.field848 = var0.method8157();
            var7 = var0.method8169();
            var4.field824 = var7 >> 16;
            var4.field851 = (var7 & '\uffff') + client.field1645;
            var4.field856 = 0;
            var4.field807 = 0;
         ...
         if ((var5 & 512) != 0) {
            for(var7 = 0; var7 < 3; ++var7) {
               var4.field897[var7] = var0.method8124();
            }
         }

         if (0 != (var5 & 128)) {
            var7 = var0.method8195();
            class333 var17 = (class333)class217.method4362(class333.method5480(), var0.method8146());
            boolean var19 = var0.method8334() == 1;
            var10 = var0.method8147();
            var11 = var0.field4878;
            if (var4.field910 != null && null != var4.field911) {
               boolean var20 = false;
               if (var17.field3858 && class217.field2588.method1049(var4.field910)) {
                  var20 = true;
               }

               if (!var20 && client.field1830 == 0 && !var4.field913) {
                  class102.field1021.field4878 = 0;
                  var0.method8188(class102.field1021.field4881, 0, var10);
                  class102.field1021.field4878 = 0;
                  String var21 = class384.method6857(class158.method2630(class307.method5489(class102.field1021)));
                  var4.field822 = var21.trim();
                  var4.field801 = var7 >> 8;
                  var4.field819 = var7 & 255;
                  var4.field843 = 150;
                  var4.field842 = var19;
                  var4.field820 = var4 != class291.field3364 && var17.field3858 && client.field1873 != "" && var21.toLowerCase().indexOf(client.field1873) == -1;
                  if (var17.field3857) {
                     var14 = var19 ? 91 : 1;
                  } else {
                     var14 = var19 ? 90 : 2;
                  ...
                  if (var17.field3856 != -1) {
                     class42.method773(var14, class96.method5151(var17.field3856) + var4.field910.method8444(), var21);
                  } else {
                     class42.method773(var14, var4.field910.method8444(), var21);
                  }
               }
            }
         ...
         if ((var5 & 1024) != 0) {
            class102.field1010[var3] = (class197)class217.method4362(class197.method7492(), var0.method8151());
         }
         ...
         if (var4.field919) {
            if (var6 == 127) {
               ...
               if (var6 != class197.field2119.field2117) {
                  var18 = (class197)class217.method4362(class197.method7492(), var6);
               } else {
   ...
   static void method64(int var0) {
      if (client.field1766 != var0) {
         ...
         if (20 == var0 || 40 == var0 || 45 == var0 || var0 == 50) {
            ...
            client.field1668 = 0;
            client.field1669 = 0;
            client.field1698.method6836(var0);
            if (20 != var0) {
         ...
         if (var0 != 5 && var0 != 10) {
            if (20 == var0) {
               ...
               class404.method7355(class243.field2846, class155.field1425, false, var4);
            } else if (var0 == 11) {
               class404.method7355(class243.field2846, class155.field1425, false, 4);
            } else if (50 == var0) {
               class75.method5452("", "Updating date of birth...", "");
               class404.method7355(class243.field2846, class155.field1425, false, 7);
            } else {
               class333.method6259();
            }
         } else {
            ...
            int var3 = var2 ? 0 : 12;
            class404.method7355(class243.field2846, class155.field1425, true, var3);
         }
   ...
   static final void method63(int var0, int var1, int var2, int var3) {
      ...
      class481.method8646(var0, var1, var2 + var0, var1 + var3);
      class221.method4389();
      ...
      class349.method6449();
      class481.method8653(var0, var1, var2, var3, 0);
      class349.method6449();
      ...
      if (2 == client.field1652) {
         ...
         if (client.field1809 > -1 && client.field1645 % 20 < 10) {
            class176.field1585[0].method8519(var0 + client.field1809 - 12, var1 + client.field1747 - 28);
         }
      }
