public class class158 extends class437 {
   public static class284 field1443 = new class284(64);
   public static class284 field1456 = new class284(64);
   ...
   public int field1446 = 255;
   public int field1447 = 255;
   public int field1448 = -1;
   public int field1450 = 70;
   public int field1453 = 30;
   ...
   void method2609(class460 var1, int var2) {
      if (1 == var2) {
         ...
         this.field1446 = var1.method8134();
      } else if (3 == var2) {
         this.field1447 = var1.method8134();
      } else if (var2 == 4) {
         this.field1448 = 0;
      } else if (5 == var2) {
         this.field1450 = var1.method8115();
      } else if (6 == var2) {
         var1.method8134();
      } else if (7 == var2) {
         this.field1449 = var1.method8133();
      } else if (8 == var2) {
         this.field1442 = var1.method8133();
      } else if (var2 == 11) {
         this.field1448 = var1.method8115();
      } else if (14 == var2) {
         this.field1453 = var1.method8134();
      } else if (15 == var2) {
         this.field1444 = var1.method8134();
      }
   ...
   public static class203 method2632(int var0) {
      ...
      if (var2 != null) {
         ...
         byte[] var3 = class203.field2293.method6167(9, var0);
         var2 = new class203();
         var2.field2260 = var0;
         if (null != var3) {
   ...
   public class473 method2631() {
      if (this.field1449 < 0) {
         ...
         if (var2 != null) {
            ...
            var2 = class389.method7007(field1441, this.field1449, 0);
            if (null != var2) {
   ...
   public class473 method2625() {
      if (this.field1442 < 0) {
         ...
         if (var2 != null) {
            ...
            var2 = class389.method7007(field1441, this.field1442, 0);
            if (null != var2) {
