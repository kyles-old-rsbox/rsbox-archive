public class class203 extends class437 {
   ...
   static class284 field2259 = new class284(50);
   static class284 field2267 = new class284(64);
   class421 field2300;
   int field2276;
   int field2279;
   int field2288;
   ...
   void method3854(class460 var1, int var2) {
      ...
      if (var2 == 1) {
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field2283[var5] = var1.method8115();
         }
      } else if (2 == var2) {
         this.field2261 = var1.method8124();
      } else if (var2 == 12) {
         this.field2262 = var1.method8134();
      } else if (var2 == 13) {
         this.field2265 = var1.method8115();
      } else if (14 == var2) {
         this.field2268 = var1.method8115();
      } else if (15 == var2) {
         this.field2266 = var1.method8115();
      } else if (16 == var2) {
         this.field2264 = var1.method8115();
      } else if (17 == var2) {
         this.field2268 = var1.method8115();
         this.field2269 = var1.method8115();
         this.field2270 = var1.method8115();
         this.field2271 = var1.method8115();
      } else if (var2 == 18) {
         var1.method8115();
      } else if (var2 >= 30 && var2 < 35) {
         this.field2284[var2 - 30] = var1.method8124();
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field2280[var5] = (short)var1.method8115();
            this.field2281[var5] = (short)var1.method8115();
         }
      } else if (var2 == 41) {
         var4 = var1.method8134();
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field2263[var5] = (short)var1.method8115();
            this.field2258[var5] = (short)var1.method8115();
         }
      } else if (var2 == 60) {
         var4 = var1.method8134();
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field2275[var5] = var1.method8115();
         }
      } else if (var2 == 93) {
         this.field2285 = false;
      } else if (95 == var2) {
         this.field2291 = var1.method8115();
      } else if (97 == var2) {
         this.field2279 = var1.method8115();
      } else if (var2 == 98) {
         this.field2288 = var1.method8115();
      } else if (var2 == 99) {
         this.field2289 = true;
      } else if (100 == var2) {
         this.field2290 = var1.method8280();
      } else if (101 == var2) {
         this.field2276 = var1.method8280() * 5;
      } else if (102 == var2) {
         this.field2292 = var1.method8115();
      } else if (103 == var2) {
         this.field2299 = var1.method8115();
         ...
         if (var2 == 107) {
            ...
            this.field2272 = var1.method8115();
         } else if (115 == var2) {
            this.field2272 = var1.method8115();
            this.field2286 = var1.method8115();
            this.field2274 = var1.method8115();
            this.field2256 = var1.method8115();
         } else if (116 == var2) {
            this.field2273 = var1.method8115();
         } else if (117 == var2) {
            this.field2273 = var1.method8115();
            this.field2277 = var1.method8115();
            this.field2297 = var1.method8115();
            this.field2294 = var1.method8115();
         } else if (var2 == 249) {
            this.field2300 = class233.method4559(var1, this.field2300);
         }
      } else {
         this.field2295 = var1.method8115();
         if (65535 == this.field2295) {
            this.field2295 = -1;
         }

         this.field2296 = var1.method8115();
         ...
         this.field2278 = new int[2 + var5];

         for(int var6 = 0; var6 <= var5; ++var6) {
            this.field2278[var6] = var1.method8115();
            if (this.field2278[var6] == 65535) {
               this.field2278[var6] = -1;
            }
         }

         this.field2278[1 + var5] = var4;
      }
   ...
   public final class209 method3855(class189 var1, int var2, class189 var3, int var4) {
      if (null != this.field2278) {
         class203 var12 = this.method3857();
         return var12 == null ? null : var12.method3855(var1, var2, var3, var4);
      } else {
         ...
         if (var6 == null) {
            ...
            for(int var8 = 0; var8 < this.field2283.length; ++var8) {
               if (!field2257.method6081(this.field2283[var8], 0)) {
                  var7 = true;
               }
            }
            ...
            if (1 == var9.length) {
               ...
               var13 = new class201(var9, var9.length);
            }

            if (null != this.field2280) {
               for(var10 = 0; var10 < this.field2280.length; ++var10) {
                  var13.method3790(this.field2280[var10], this.field2281[var10]);
               }
            }

            if (null != this.field2263) {
               for(var10 = 0; var10 < this.field2263.length; ++var10) {
                  var13.method3791(this.field2263[var10], this.field2258[var10]);
               }
            }

            var6 = var13.method3796(this.field2290 + 64, 850 + this.field2276, -30, -50, -30);
            field2259.method5434(var6, (long)this.field2260);
         }

         class209 var11;
         if (null != var1 && null != var3) {
            var11 = var1.method3472(var6, var2, var3, var4);
         } else if (null != var1) {
            var11 = var1.method3479(var6, var2);
         } else if (null != var3) {
            var11 = var3.method3479(var6, var4);
         } else {
            var11 = var6.method3988(true);
         }

         if (128 != this.field2279 || 128 != this.field2288) {
            var11.method4062(this.field2279, this.field2288, this.field2279);
         }
   ...
   public final class201 method3885() {
      if (null != this.field2278) {
         class203 var6 = this.method3857();
         return var6 == null ? null : var6.method3885();
         ...
         for(int var3 = 0; var3 < this.field2275.length; ++var3) {
            if (!field2257.method6081(this.field2275[var3], 0)) {
               var2 = true;
            }
         }
   ...
   public int method3859(int var1, int var2) {
      ...
      if (null == var5) {
         ...
         class426 var6 = (class426)var5.method7781((long)var1);
         if (null == var6) {
            var4 = var2;
         } else {
            var4 = var6.field4680;
   ...
   public String method3860(int var1, String var2) {
      return class369.method6727(this.field2300, var1, var2);
   }
   ...
   static final void method3865() {
      for(class77 var1 = (class77)client.field1779.method6356(); null != var1; var1 = (class77)client.field1779.method6350()) {
