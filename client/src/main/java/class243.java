...
public class class243 {
   public static class265 field2848 = new class265(37748736, 256);
   ...
   void method4735(int var1, int var2, int var3) {
      ...
      if (var5 != null) {
         if (var3 == this.field2849 * 64) {
            var5.method8476(var1, var2);
         } else {
            var5.method8477(var1, var2, var3, var3);
         }
   ...
   static final void method4768(class460 var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
         ...
         while(true) {
            var8 = client.field1932 < 209 ? var0.method8134() : var0.method8115();
            if (0 == var8) {
               if (0 == var1) {
            ...
            if (var8 <= 49) {
               class82.field723[var1][var2][var3] = client.field1932 < 209 ? (short)var0.method8280() : (short)var0.method8197();
   ...
   void method4744(int var1, class240 var2, class488[] var3, class319 var4, class319 var5) {
      ...
      if (null != this.field2840 || !this.field2847.isEmpty()) {
         if (method2611(this.field2844, this.field2845, var1) == null) {
            ...
            var7 &= var5.method6083(var9);
            if (var7) {
               byte[] var8 = var5.method6095(var9);
               class241 var10;
               if (var8 == null) {
                  var10 = new class241();
               } else {
   ...
   void method4786(int var1, int var2, class239 var3, class240 var4, class241 var5) {
      ...
      if (var7 == -1 && -1 == var8) {
         class481.method8653(this.field2849 * var1, (63 - var2) * this.field2849, this.field2849, this.field2849, this.field2853);
      }
      ...
      if (-1 != var8) {
         ...
         if (null != var13) {
            ...
            byte[] var14 = class199.field2188.method6167(4, var8);
            var13 = new class199();
            if (var14 != null) {
               var13.method3717(new class460(var14), var8);
            }
         ...
         if (var12 == null) {
            ...
            if (var12.field2185 >= 0) {
               ...
               var10 = class221.field2640[var22] | -16777216;
      ...
      if (var8 > -1 && 0 == var3.field2818[0][var1][var2]) {
         class481.method8653(var1 * this.field2849, this.field2849 * (63 - var2), this.field2849, this.field2849, var9);
      } else {
         var10 = this.method4751(var1, var2, var3, var5);
         if (var8 == -1) {
            class481.method8653(this.field2849 * var1, (63 - var2) * this.field2849, this.field2849, this.field2849, var10);
         } else {
      ...
      for(int var6 = 1; var6 < var3.field2813; ++var6) {
         ...
         if (var7 > -1) {
            ...
            if (var11 != null) {
               ...
               byte[] var12 = class199.field2188.method6167(4, var7);
               var11 = new class199();
               if (var12 != null) {
                  var11.method3717(new class460(var12), var7);
               }
            ...
            if (var10 == null) {
               ...
               if (var10.field2185 >= 0) {
                  ...
                  var8 = class221.field2640[var20] | -16777216;
               } else if (var10.field2184 == 16711935) {
                  var8 = var9;
               } else {
                  var13 = var10.field2194;
                  var21 = var10.field2182;
                  ...
                  int var16 = (var21 / 32 << 7) + (var13 / 4 << 10) + var15 / 2;
                  byte var18 = 96;
                  int var17;
                  if (-2 == var16) {
                     var17 = 12345678;
            ...
            if (var3.field2818[var6][var1][var2] == 0) {
               class481.method8653(var1 * this.field2849, this.field2849 * (63 - var2), this.field2849, this.field2849, var8);
            } else {
               ...
               if (var11 || class87.method1851(var10.field2929)) {
                  ...
                  if (var13.field2075 != -1) {
                     if (var13.field2075 != 46 && 52 != var13.field2075) {
                        var4[var13.field2075].method8750(this.field2849 * var1, this.field2849 * (63 - var2), this.field2849 * 2, this.field2849 * 2);
                     } else {
                        var4[var13.field2075].method8750(var1 * this.field2849, (63 - var2) * this.field2849, 1 + this.field2849 * 2, 1 + this.field2849 * 2);
                     }
                  }
               }
            }
            ...
            for(int var8 = 0; var8 < var7.length; ++var8) {
               ...
               if (class239.method4679(var9.field2929)) {
                  ...
                  if (class306.field3663.field3670 == var9.field2929) {
                     if (var9.field2926 == 0) {
                        class481.method8659(var1 * this.field2849, this.field2849 * (63 - var2), 1, var11);
                     }

                     if (var9.field2926 == 1) {
                        class481.method8659(this.field2849 + this.field2849 * var1 - 1, this.field2849 * (63 - var2), 1, var11);
                     }

                     if (var9.field2926 == 2) {
                        class481.method8659(var1 * this.field2849 + this.field2849 - 1, this.field2849 * (63 - var2) + this.field2849 - 1, 1, var11);
                     }

                     if (var9.field2926 == 3) {
                        class481.method8659(this.field2849 * var1, this.field2849 * (63 - var2) + this.field2849 - 1, 1, var11);
                     }
                  }
                  ...
                  if (class306.field3651.field3670 == var9.field2929) {
                     ...
                     if (var12 == 0) {
                        for(var13 = 0; var13 < this.field2849; ++var13) {
                           class481.method8659(this.field2849 * var1 + var13, (64 - var2) * this.field2849 - 1 - var13, 1, var11);
                        }
                     } else {
                        for(var13 = 0; var13 < this.field2849; ++var13) {
                           class481.method8659(this.field2849 * var1 + var13, var13 + this.field2849 * (63 - var2), 1, var11);
                        }
                     }
                  }
               }
   ...
   void method4803(class160 var1, int var2, int var3, int var4, int var5) {
      ...
      if (null != var7) {
         var7.method8519(var2 - var7.field4959 / 2, var3 - var7.field4951 / 2);
         if (var4 % var5 < var5 / 2) {
            class481.method8651(var2, var3, 15, 16776960, 128);
            class481.method8651(var2, var3, 7, 16777215, 256);
         }
   ...
   void method4758(class160 var1, int var2, int var3) {
      ...
      if (null != var5) {
         ...
         var5.method8519(var2 + var6, var3 + var7);
      }
   ...
   void method4763(class251 var1, class160 var2, int var3, int var4, float var5) {
      ...
      if (var7 != null) {
         if (var7.field2967.method4098(var5)) {
            ...
            var8.method6863(var7.field2971, var3 - var7.field2968 / 2, var4, var7.field2968, var7.field2969, -16777216 | var2.field1475, 0, 1, 0, var8.field4435 / 2);
         }
      }
   }
      ...
      if (var1.field1470 != null && this.field2852 != null && this.field2852.get(class210.field2456) != null) {
         ...
         if (var3 == null) {
            ...
            if (var4 == null) {
               ...
               int var5 = var4.method6862(var1.field1470, 1000000);
               String[] var6 = new String[var5];
               var4.method6902(var1.field1470, (int[])null, var6);
               ...
               for(int var10 = 0; var10 < var9.length; ++var10) {
                  ...
                  int var12 = var4.method6887(var11);
                  if (var12 > var8) {
                     var8 = var12;
                  }
               }
   ...
   void method4767(int var1, int var2, int var3, int var4) {
      var3 %= 4;
      if (0 == var3) {
         class481.method8660(var1 * this.field2849, this.field2849 * (63 - var2), this.field2849, var4);
      }

      if (var3 == 1) {
         class481.method8659(this.field2849 * var1, (63 - var2) * this.field2849, this.field2849, var4);
      }

      if (2 == var3) {
         class481.method8660(this.field2849 + this.field2849 * var1 - 1, this.field2849 * (63 - var2), this.field2849, var4);
      }

      if (var3 == 3) {
         class481.method8659(this.field2849 * var1, this.field2849 + this.field2849 * (63 - var2) - 1, this.field2849, var4);
      }
