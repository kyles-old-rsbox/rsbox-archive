public class class207 extends class437 {
   ...
   static class284 field2353 = new class284(64);
   static class284 field2354 = new class284(30);
   ...
   public static class207 method803(int var0) {
      ...
      if (var2 != null) {
         ...
         byte[] var3 = field2363.method6167(13, var0);
         var2 = new class207();
         var2.field2355 = var0;
         if (var3 != null) {
   ...
   void method3971(class460 var1, int var2) {
      if (1 == var2) {
         this.field2356 = var1.method8115();
      } else if (var2 == 2) {
         this.field2359 = var1.method8115();
      } else if (var2 == 4) {
         this.field2362 = var1.method8115();
      } else if (5 == var2) {
         this.field2364 = var1.method8115();
      } else if (var2 == 6) {
         this.field2360 = var1.method8115();
      } else if (var2 == 7) {
         this.field2365 = var1.method8134();
      } else if (var2 == 8) {
         this.field2366 = var1.method8134();
      } else {
         int var4;
         int var5;
         if (40 == var2) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field2358[var5] = (short)var1.method8115();
               this.field2357[var5] = (short)var1.method8115();
            }
         } else if (41 == var2) {
            var4 = var1.method8134();
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field2351[var5] = (short)var1.method8115();
               this.field2361[var5] = (short)var1.method8115();
            }
         }
      }
