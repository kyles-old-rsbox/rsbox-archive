...
public final class class412 {
   ...
   static class412[] field4560 = new class412[0];
   static int field4561 = 100;
   static int field4562;
   public float[] field4563 = new float[16];
   ...
   public class412(class412 var1) {
      this.method7415(var1);
   }

   public class412(class460 var1, boolean var2) {
      this.method7456(var1, var2);
   }

   void method7456(class460 var1, boolean var2) {
      if (var2) {
         class414 var4 = new class414();
         int var7 = var1.method8197();
         var7 &= 16383;
         float var6 = (float)((double)((float)var7 / 16384.0F) * 6.283185307179586D);
         var4.method7495(var6);
         var4.method7513(class422.method3465(var1.method8197()));
         int var10 = var1.method8197();
         var10 &= 16383;
         float var9 = (float)((double)((float)var10 / 16384.0F) * 6.283185307179586D);
         var4.method7514(var9);
         var4.method7497((float)var1.method8197(), (float)var1.method8197(), (float)var1.method8197());
         this.method7421(var4);
      } else {
         for(int var11 = 0; var11 < 16; ++var11) {
            this.field4563[var11] = var1.method8121();
         }
      }
   ...
   public void method7415(class412 var1) {
      System.arraycopy(var1.field4563, 0, this.field4563, 0, 16);
   }

   public void method7447(float var1) {
      this.method7417(var1, var1, var1);
   }

   public void method7417(float var1, float var2, float var3) {
      this.method7413();
   ...
   public void method7440(class412 var1) {
   ...
   public void method7419(class412 var1) {
   ...
   public static class488 method7408(class319 var0, int var1) {
   ...
   public void method7420(class415 var1) {
   ...
   public float[] method7425() {
      ...
      var2[0] = var3.method7268();
      var2[1] = var4.method7268();
      var2[2] = var5.method7268();
      return var2;
   }
}
