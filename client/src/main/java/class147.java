...
public class class147 extends class427 {
   ...
   public int[] method2502() {
      if (null == this.field1348) {
         ...
         for(int var3 = 0; var3 < this.field1347.size(); this.field1348[var3] = var3++) {
            var2[var3] = ((class133)this.field1347.get(var3)).field1254.method8441();
         }
   ...
   public int method2505(String var1) {
      if (!this.field1346) {
         ...
         for(int var3 = 0; var3 < this.field1347.size(); ++var3) {
            if (((class133)this.field1347.get(var3)).field1254.method8444().equalsIgnoreCase(var1)) {
               return var3;
            }
         }
   ...
   void method2506(class460 var1) {
      ...
      super.field4681 = var1.method8120();
      this.field1349 = var1.method8120();
      this.field1350 = var1.method8124();
      var1.method8122();
      this.field1351 = var1.method8280();
      this.field1345 = var1.method8280();
      int var5 = var1.method8115();
      if (var5 > 0) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            if (this.field1346) {
               var7.field1254 = new class472(var1.method8124());
            }

            var7.field1256 = var1.method8280();
            var7.field1249 = var1.method8115();
            if (var4 >= 3) {
               var1.method8122();
            }
   ...
   static final void method2521(int var0) {
      ...
      if (0 != var2) {
         ...
         if (var2 == 10) {
            if (0 == var3) {
               client.method6041(127);
            }

            if (var3 == 1) {
               client.method6041(96);
            }

            if (2 == var3) {
               client.method6041(64);
            }

            if (var3 == 3) {
               client.method6041(32);
            }
