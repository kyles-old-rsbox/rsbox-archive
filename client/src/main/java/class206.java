public class class206 extends class437 {
   public static class284 field2330 = new class284(64);
   public static class284 field2331 = new class284(64);
   public static class284 field2332 = new class284(20);
   ...
   int field2349 = -1;
   String field2342 = "";
   public int field2327 = 70;
   public int field2336 = 16777215;
   ...
   void method3934(class460 var1, int var2) {
      if (var2 == 1) {
         this.field2335 = var1.method8133();
      } else if (2 == var2) {
         this.field2336 = var1.method8305();
      } else if (3 == var2) {
         this.field2343 = var1.method8133();
      } else if (4 == var2) {
         this.field2347 = var1.method8133();
      } else if (var2 == 5) {
         this.field2337 = var1.method8133();
      } else if (6 == var2) {
         this.field2341 = var1.method8133();
      } else if (7 == var2) {
         this.field2345 = var1.method8197();
      } else if (8 == var2) {
         this.field2342 = var1.method8125();
      } else if (9 == var2) {
         this.field2327 = var1.method8115();
      } else if (var2 == 10) {
         this.field2350 = var1.method8197();
      } else if (11 == var2) {
         this.field2344 = 0;
      } else if (12 == var2) {
         this.field2338 = var1.method8134();
      } else if (13 == var2) {
         this.field2339 = var1.method8197();
      } else if (14 == var2) {
         this.field2344 = var1.method8115();
      } else if (var2 == 17 || var2 == 18) {
         this.field2349 = var1.method8115();
         if (this.field2349 == 65535) {
            this.field2349 = -1;
         }

         this.field2340 = var1.method8115();
         ...
         for(int var6 = 0; var6 <= var5; ++var6) {
            this.field2348[var6] = var1.method8115();
   ...
   public class473 method3954() {
      if (this.field2343 < 0) {
         ...
         if (null != var2) {
            ...
            var2 = class389.method7007(field2328, this.field2343, 0);
            if (var2 != null) {
   ...
   public class473 method3944() {
      if (this.field2337 < 0) {
         ...
         if (null != var2) {
            ...
            var2 = class389.method7007(field2328, this.field2337, 0);
            if (var2 != null) {
   ...
   public class473 method3936() {
      if (this.field2347 < 0) {
         ...
         if (null != var2) {
            ...
            var2 = class389.method7007(field2328, this.field2347, 0);
            if (var2 != null) {
   ...
   public class473 method3963() {
      if (this.field2341 < 0) {
         ...
         if (var2 != null) {
            ...
            var2 = class389.method7007(field2328, this.field2341, 0);
            if (null != var2) {
   ...
   public class376 method3938() {
      if (this.field2335 == -1) {
         ...
         if (var2 != null) {
            ...
            var2 = class378.method6798(field2328, field2329, this.field2335, 0);
            if (null != var2) {
