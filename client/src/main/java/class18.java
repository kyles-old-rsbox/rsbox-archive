...
public class class18 implements class360 {
	...
	static {
		field87 = new class18(0, "POST", true, true);
		field84 = new class18(1, "GET", true, false);
		field88 = new class18(2, "PUT", false, true);
		field86 = new class18(3, "PATCH", false, true);
		field91 = new class18(4, "DELETE", false, true);
	}
