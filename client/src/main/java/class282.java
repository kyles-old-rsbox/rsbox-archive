public class class282 {
   ...
   public static int method5406(class460 var0, String var1) {
      ...
      var0.method8240(var4.length);
      var0.field4878 += class307.field3673.method6044(var4, 0, var4.length, var0.field4881, var0.field4878);
   ...
   public static int method6298(int var0) {
   ...
   public static int method651(int var0, int var1, int var2) {
      int var4 = method6298(1 + (var2 - var1));
      var4 <<= var1;
      return var0 & ~var4;
   }
