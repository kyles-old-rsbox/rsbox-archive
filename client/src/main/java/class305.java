public class class305 {
	...
	static {
		field3642 = new int[]{8, 11, 4, 6, 9, 7, 10};
	...
	public void method5997(int[] var1, class179[] var2, boolean var3, int[] var4, int var5, int var6, int var7) {
		...
		this.field3644 = var3;
		this.field3641 = var7;
		this.method5998(var1, var4, var5, var6);
	}
	...
	public void method6000(int var1, boolean var2) {
	...
	public void method6012(int var1, boolean var2) {
	...
	public void method5999(int var1) {
		if (var1 != this.field3639) {
			this.method5998((int[])null, this.field3637, var1, -1);
		}
	}
	...
	public class209 method6003(class189 var1, int var2, class189 var3, int var4) {
		if (this.field3640 != -1) {
			...
			if (null == var19) {
				...
				if (null == var19) {
					...
					class201 var21 = new class201(var20, var12);

					for (var14 = 0; var14 < 5; ++var14) {
						if (this.field3637[var14] < class37.field251[var14].length) {
							var21.method3790(class172.field1551[var14], class37.field251[var14][this.field3637[var14]]);
						}

						if (this.field3637[var14] < class97.field974[var14].length) {
							var21.method3790(class9.field39[var14], class97.field974[var14][this.field3637[var14]]);
						}
					}

					var19 = var21.method3796(64, 850, -30, -50, -30);
			...
			if (var1 == null && null == var3) {
				...
				class209 var22;
				if (var1 != null && null != var3) {
					var22 = var1.method3472(var19, var2, var3, var4);
				} else if (null != var1) {
					var22 = var1.method3479(var19, var2);
				} else {
					var22 = var3.method3479(var19, var4);
				}
