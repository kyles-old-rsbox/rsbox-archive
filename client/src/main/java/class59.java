...
public class class59 {
   ...
   int[] field446 = new int[]{0, 0, 0, 0, 0};
   ...
   final int[] method1291(int var1, int var2) {
      class386.method6962(field438, 0, var1);
      if (var2 < 10) {
         return field438;
      } else {
         ...
         for(var11 = 0; var11 < var1; ++var11) {
            ...
            if (this.field425 != null) {
               ...
               var13 = var13 * ((this.method1292(var10, var15, this.field425.field228) >> 1) + '\u8000') >> 15;
   ...
   final void method1293(class460 var1) {
      ...
      for(int var3 = 0; var3 < 10; ++var3) {
         int var4 = var1.method8200();
         if (var4 == 0) {
            break;
         }

         this.field446[var3] = var4;
         this.field421[var3] = var1.method8212();
         this.field431[var3] = var1.method8200();
      }

      this.field432 = var1.method8200();
      this.field429 = var1.method8200();
      this.field436 = var1.method8115();
      this.field428 = var1.method8115();
