...
public class class336 extends class319 {
   static CRC32 field3879 = new CRC32();
   boolean field3876 = false;
   class392 field3874;
   class392 field3877;
   int field3869;
   int field3875;
   ...
   void method6086(int var1) {
      if (null != this.field3877 && this.field3878 != null && this.field3878[var1]) {
         ...
         synchronized(class322.field3759) {
            for(class334 var7 = (class334)class322.field3759.method6356(); null != var7; var7 = (class334)class322.field3759.method6350()) {
         ...
         if (var5 != null) {
            this.method6271(var3, var1, var5, true);
         } else {
            byte[] var6 = var3.method7137(var1);
            this.method6271(var3, var1, var6, true);
         }
      } else {
   ...
   public void method6290(int var1, int var2) {
      this.field3869 = var1;
      this.field3881 = var2;
      if (this.field3874 != null) {
         ...
         byte[] var7 = null;
         synchronized(class322.field3759) {
            for(class334 var9 = (class334)class322.field3759.method6356(); var9 != null; var9 = (class334)class322.field3759.method6350()) {
         ...
         if (var7 != null) {
            this.method6271(var5, var4, var7, true);
         } else {
            byte[] var8 = var5.method7137(var4);
            this.method6271(var5, var4, var8, true);
         }
      } else {
   ...
   public void method6270(int var1, byte[] var2, boolean var3, boolean var4) {
      if (var3) {
         if (this.field3880 == 1) {
   ...
   void method6271(class392 var1, int var2, byte[] var3, boolean var4) {
      int var6;
      if (this.field3874 == var1) {
         if (this.field3880 == 1) {
            ...
            if (this.field3869 != var6) {
               ...
               class460 var10 = new class460(class231.method4537(var3));
               int var8 = var10.method8134();
               if (5 != var8 && var8 != 6) {
                  throw new RuntimeException(var8 + "," + this.field3875 + "," + var2);
               } else {
                  int var9 = 0;
                  if (var8 >= 6) {
                     var9 = var10.method8119();
                  }

                  if (this.field3881 != var9) {
                     class169.method2714(this, 255, this.field3875, this.field3869, (byte)0, true);
                  } else {
                     this.method6077(var3);
                     this.method6277();
                  }
               }
            }
         ...
         if (null != var3 && var3.length > 2) {
            ...
            if (super.field3737[var2] == var6 && var7 == super.field3738[var2]) {
   ...
   public boolean method6272(int var1) {
      return this.field3878[var1];
   }

   public boolean method6268(int var1) {
      return this.method6090(var1) != null;
   }
   ...
   static void method6274(int var0, int var1) {
      int[] var3 = new int[9];
