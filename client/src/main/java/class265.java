public final class class265 {
   ...
   public Object method5177(long var1) {
      class285 var3 = (class285)this.field3003.method7781(var1);
      if (var3 == null) {
         return null;
      } else {
         ...
         if (var4 == null) {
            ...
            if (var3.method5447()) {
               ...
               this.field3003.method7774(var5, var3.field4681);
               this.field3004.method6592(var5);
               var5.field4723 = 0L;
               var3.remove();
               var3.method7882();
            } else {
               this.field3004.method6592(var3);
               var3.field4723 = 0L;
            }
   ...
   public void method5170(Object var1, long var2, int var4) {
      if (var4 > this.field3001) {
         ...
         while(this.field3002 < 0) {
            class285 var5 = (class285)this.field3004.method6581();
            if (var5 == null) {
         ...
         this.field3003.method7774(var6, var2);
         this.field3004.method6592(var6);
         var6.field4723 = 0L;
      }
   }

   public void method5193(int var1) {
      for(class285 var2 = (class285)this.field3004.method6582(); var2 != null; var2 = (class285)this.field3004.method6584()) {
         if (var2.method5447()) {
            ...
            this.field3003.method7774(var3, var2.field4681);
            class355.method6580(var3, var2);
            var2.remove();
            var2.method7882();
         }
      }
   ...
   public void method5185() {
      this.field3004.method6590();
      this.field3003.method7775();
