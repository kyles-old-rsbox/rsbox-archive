final class class100 implements class301 {
   ...
   public void method5979() {
      if (null != this.val$cc && this.val$cc.method5872().field3686 != null) {
         class79 var2 = new class79();
         var2.method1599(this.val$cc);
         var2.method1602(this.val$cc.method5872().field3686);
         client.method7844().method6347(var2);
      }
   ...
   static int method1986(int var0, class78 var1, boolean var2) {
      ...
      if (var0 != 1200 && var0 != 1205 && 1212 != var0) {
         if (1201 == var0) {
            ...
            var4.field3504 = 3;
            var4.field3505 = class291.field3364.field911.method6021();
            return 1;
         } else {
            return 2;
         }
