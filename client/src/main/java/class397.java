...
public class class397 implements Runnable {
	...
	public static class473[] method7205(class319 var0, int var1, int var2) {
	...
	public void run() {
		while (true) {
			...
			int var7;
			try {
				var7 = this.field4494.read(this.field4496, this.field4497, var1);
				if (var7 == -1) {
			...
			synchronized(this) {
				this.field4497 = (this.field4497 + var7) % this.field4495;
			}
		}
	}
