...
public final class class464 {
	...
	final void method8379(long var1) throws IOException {
		this.field4901.seek(var1);
		this.field4903 = var1;
	}

	public final void method8370(byte[] var1, int var2, int var3) throws IOException {
	...
	public final void method8374() throws IOException {
		this.method8372(false);
	}

	public final void method8372(boolean var1) throws IOException {
	...
	public final long method8373() throws IOException {
		return this.field4901.length();
	}

	public final int method8369(byte[] var1, int var2, int var3) throws IOException {
