...
public class class205 implements class29 {
   ...
   boolean[] field2316 = new boolean[112];
   boolean[] field2319 = new boolean[112];
   boolean[] field2322 = new boolean[112];
   char[] field2318 = new char[128];
   int field2314 = 0;
   int field2315 = 0;
   int field2320 = 0;
   int field2323 = 0;
   int[] field2309 = new int[128];
   int[] field2325 = new int[128];
   public char field2321;
   public int field2312 = 0;
   public int field2317;
   public int[] field2311 = new int[128];
