...
public class class73 {
      ...
      for(int var3 = 0; var3 < var0.length; ++var3) {
         ...
         if (null != var4 && var1 == var4.field3596 && (!var4.field3459 || !client.method343(var4))) {
            if (var4.field3462 == 0) {
               ...
               if (var5 != null) {
                  class378.method6797(var5.field796);
               }
            }
   ...
   static final void method1487(class300 var0, int var1, int var2, int var3) {
      class349.method6449();
      class298 var5 = var0.method5851(false);
      if (null != var5) {
         class481.method8646(var1, var2, var1 + var5.field3435, var2 + var5.field3433);
         if (client.field1709 != 2 && 5 != client.field1709) {
            ...
            class309.field3678.method8495(var1, var2, var5.field3435, var5.field3433, var7, var8, var6, 256, var5.field3432, var5.field3434);
            ...
            for(var9 = 0; var9 < 104; ++var9) {
               for(var10 = 0; var10 < 104; ++var10) {
                  class343 var17 = client.field1865[class55.field396][var9][var10];
                  if (null != var17) {
            ...
            for(var9 = 0; var9 < client.field1691; ++var9) {
               class81 var15 = client.field1902[client.field1692[var9]];
               if (var15 != null && var15.method1869()) {
                  class203 var18 = var15.field709;
                  if (null != var18 && null != var18.field2278) {
                     var18 = var18.method3857();
                  }

                  if (var18 != null && var18.field2285 && var18.field2282) {
                     var12 = var15.field827 / 32 - class291.field3364.field827 / 32;
                     var13 = var15.field802 / 32 - class291.field3364.field802 / 32;
            ...
            int[] var16 = class102.field1013;

            for(var11 = 0; var11 < var9; ++var11) {
               class93 var19 = client.field1763[var16[var11]];
               if (var19 != null && var19.method1869() && !var19.field913 && var19 != class291.field3364) {
                  var13 = var19.field827 / 32 - class291.field3364.field827 / 32;
                  int var14 = var19.field802 / 32 - class291.field3364.field802 / 32;
                  if (var19.method1907()) {
                     class275.method5224(var1, var2, var13, var14, class64.field505[3], var5);
                  } else if (class291.field3364.field921 != 0 && var19.field921 != 0 && var19.field921 == class291.field3364.field921) {
                     class275.method5224(var1, var2, var13, var14, class64.field505[4], var5);
                  } else if (var19.method1939()) {
                     class275.method5224(var1, var2, var13, var14, class64.field505[5], var5);
                  } else if (var19.method1951()) {
            ...
            if (!class291.field3364.field913) {
               class481.method8653(var5.field3435 / 2 + var1 - 1, var2 + var5.field3433 / 2 - 1, 3, 3, 16777215);
            }
         } else {
            class481.method8706(var1, var2, 0, var5.field3432, var5.field3434);
         }
