public class class38 extends class51 {
   class343 field253 = new class343();
   class343 field254 = new class343();
   int field255 = 0;
   int field256 = -1;

   public final synchronized void method718(class51 var1) {
      this.field254.method6345(var1);
   }
   ...
   void method720() {
      if (this.field255 > 0) {
         for(class68 var1 = (class68)this.field253.method6356(); var1 != null; var1 = (class68)this.field253.method6350()) {
   ...
   protected class51 method1007() {
      return (class51)this.field254.method6356();
   }

   protected class51 method1004() {
      return (class51)this.field254.method6350();
   }
   ...
   public final synchronized void method1005(int[] var1, int var2, int var3) {
      do {
         ...
         this.field255 += var4;
         this.method720();
         class68 var5 = (class68)this.field253.method6356();
         synchronized(var5) {
   ...
   void method727(int[] var1, int var2, int var3) {
      for(class51 var4 = (class51)this.field254.method6356(); var4 != null; var4 = (class51)this.field254.method6350()) {
   ...
   public final synchronized void method1001(int var1) {
      do {
         ...
         this.field255 += var2;
         this.method720();
         class68 var3 = (class68)this.field253.method6356();
         synchronized(var3) {
   ...
   void method729(int var1) {
      for(class51 var2 = (class51)this.field254.method6356(); var2 != null; var2 = (class51)this.field254.method6350()) {
