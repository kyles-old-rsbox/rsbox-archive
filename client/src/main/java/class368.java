public class class368 {
   ...
   public static int method6726(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
      float var8 = 0.0F;
      ...
      float var22 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class127.field1227;
      if (var8 <= var22) {
         return -1;
      } else {
         ...
         if (var1 == 0) {
            ...
            class405 var12 = new class405(var10, var1);
            ...
            int var15 = method6726(var13, var1 - 1, var2, false, var4, false, var25);
            if (-1 == var15) {
               return 0;
            } else {
               boolean var16 = false;
               ...
               for(int var21 = 0; var21 <= var15; ++var21) {
                  ...
                  if (var16) {
                     ...
                     var6[var11++] = class415.method7523(var12, var17, var20, 0.0F);
   ...
   static final void method6725(int var0) {
      method6724();
      switch(var0) {
      case 1:
         class75.method230();
