public class class112 extends class437 {
   boolean field1106;
   class106[][] field1101 = (class106[][])null;
   int field1103;
   int field1105 = 0;
   public class106[][] field1102 = (class106[][])null;
   public class230 field1104;

   class112(class319 var1, class319 var2, int var3, boolean var4) {
      this.field1103 = var3;
      byte[] var5 = var1.method6167(this.field1103 >> 16 & '\uffff', this.field1103 & '\uffff');
      class460 var6 = new class460(var5);
      int var7 = var6.method8134();
      int var8 = var6.method8115();
      byte[] var9;
      if (var4) {
         var9 = var2.method6123(0, var8);
      } else {
         var9 = var2.method6123(var8, 0);
      }
   ...
   void method2145(class460 var1, int var2) {
      var1.method8115();
      var1.method8115();
      this.field1105 = var1.method8134();
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         int var15 = var1.method8212();
         class121 var10 = class87.method1855(var1.method8134());
         ...
         if (var13[var15] == null) {
            var13[var15] = new class106[var12];
         }

         var13[var15][var10.method2281()] = var11;
   ...
   void method2149(class412 var1, int var2, class113 var3, int var4) {
      ...
      var15.method7543(1.0F, 0.0F, 0.0F, var7);
      class415 var16 = class53.method1114();
      var16.method7543(0.0F, 1.0F, 0.0F, var8);
      class415 var17 = class53.method1114();
      var17.method7543(0.0F, 0.0F, 1.0F, var9);
      class415 var13 = class53.method1114();
      var13.method7520(var17);
      var13.method7520(var15);
      var13.method7520(var16);
      class412 var14 = class295.method5542();
      var14.method7420(var13);
      var1.method7419(var14);
      var15.method7528();
      var16.method7528();
      var17.method7528();
      var13.method7528();
   ...
   void method2144(class412 var1, int var2, class113 var3, int var4) {
      ...
      var13.method7417(var7, var8, var9);
      var1.method7419(var13);
      var13.method7462();
   }
   ...
   static int method2170(class300 var0) {
      if (11 != var0.field3462) {
         ...
         class57.field405[++class126.field1220 - 1] = var0.method5929(var2);
         return 1;
      }
   }
   ...
   static void method2169(int var0) {
      ...
      if (!var6 && client.field1758.method7931()) {
         class74.method1490(9);
      }
