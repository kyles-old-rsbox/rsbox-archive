public class class55 extends class204 {
   ...
   public static class177 method1123(int var0) {
      ...
      if (null != var2) {
         ...
         byte[] var3 = class359.field4313.method6167(5, var0);
         var2 = new class177();
         if (null != var3) {
   ...
   static void method1117(int var0, int var1, int var2, int var3) {
      for(class70 var5 = (class70)class70.field563.method6356(); var5 != null; var5 = (class70)class70.field563.method6350()) {
            ...
            if (var6 - 64 <= var5.field560 && class413.field4575.method1736() != 0 && var0 == var5.field558) {
               ...
               if (var5.field565 == null) {
                  if (var5.field564 >= 0) {
                     ...
                     if (var8 != null) {
                        RawSound var9 = var8.method605().method752(class233.field2759);
               ...
               if (var5.field569 == null) {
                  if (var5.field561 != null && (var5.field557 -= var3) <= 0) {
                     ...
                     if (var13 != null) {
                        RawSound var14 = var13.method605().method752(class233.field2759);
