public class class182 extends class437 {
   ...
   static class284 field1627 = new class284(64);
   int[] field1624;
   int[] field1629 = new int[]{-1, -1, -1, -1, -1};
   short[] field1620;
   short[] field1621;
   short[] field1625;
   short[] field1628;
   ...
   void method2849(class460 var1, int var2) {
      if (1 == var2) {
         this.field1623 = var1.method8134();
      } else {
         int var4;
         int var5;
         if (var2 == 2) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field1624[var5] = var1.method8115();
            }
         } else if (var2 == 3) {
            this.field1630 = true;
         } else if (40 == var2) {
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field1625[var5] = (short)var1.method8115();
               this.field1620[var5] = (short)var1.method8115();
            }
         } else if (41 == var2) {
            var4 = var1.method8134();
            ...
            for(var5 = 0; var5 < var4; ++var5) {
               this.field1621[var5] = (short)var1.method8115();
               this.field1628[var5] = (short)var1.method8115();
            }
         } else if (var2 >= 60 && var2 < 70) {
            this.field1629[var2 - 60] = var1.method8115();
         }
      }
   ...
   public static void method2856() {
      try {
         if (1 == class279.field3202) {
            int var1 = class279.midiPcmStream.method5382();
            if (var1 > 0 && class279.midiPcmStream.method5278()) {
               var1 -= class13.field67;
               if (var1 < 0) {
                  var1 = 0;
               }

               class279.midiPcmStream.method5271(var1);
               return;
            }

            class279.midiPcmStream.method5365();
            class279.midiPcmStream.method5275();
   ...
   public boolean method2848() {
      if (this.field1624 == null) {
         ...
         for(int var3 = 0; var3 < this.field1624.length; ++var3) {
            if (!field1619.method6081(this.field1624[var3], 0)) {
               var2 = false;
            }
         }
   ...
   public boolean method2850() {
      ...
      for(int var3 = 0; var3 < 5; ++var3) {
         if (-1 != this.field1629[var3] && !field1619.method6081(this.field1629[var3], 0)) {
            var2 = false;
         }
      }
