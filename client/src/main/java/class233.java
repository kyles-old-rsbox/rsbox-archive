public class class233 {
   ...
   static final class421 method4559(class460 var0, class421 var1) {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         boolean var5 = var0.method8134() == 1;
         int var6 = var0.method8305();
         Object var7;
         if (var5) {
            var7 = new class418(var0.method8124());
         } else {
            var7 = new class426(var0.method8119());
         }

         var1.method7774((class427)var7, (long)var6);
      }
   ...
   static void method4557(int var0, int var1, int var2, int var3) {
      class87 var5 = (class87)class87.field782.get((long)var0);
      if (null == var5) {
         var5 = new class87();
         class87.field782.put(var5, (long)var0);
      }
