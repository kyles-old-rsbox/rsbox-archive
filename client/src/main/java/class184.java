public class class184 extends class437 {
   public static class284 field1947 = new class284(64);
   static final int[] field1949 = new int[32];
   ...
   void method3403(class460 var1, int var2) {
      if (1 == var2) {
         this.field1945 = var1.method8115();
         this.field1946 = var1.method8134();
         this.field1948 = var1.method8134();
      }
