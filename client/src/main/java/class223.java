public class class223 {
   static int[] field2651 = new int[500];
   static int[] field2652 = new int[500];
   static int[] field2653 = new int[500];
   static int[] field2655 = new int[500];
   boolean field2659 = false;
   class230 field2650 = null;
   int field2654 = -1;
   int[] field2649;
   int[] field2656;
   int[] field2657;
   ...
   class223(byte[] var1, class230 var2) {
      ...
      for(var8 = 0; var8 < var5; ++var8) {
         ...
         if (var9 > 0) {
            ...
            if ((var9 & 1) != 0) {
               field2653[var7] = var4.method8212();
            } else {
               field2653[var7] = var11;
            }

            if ((var9 & 2) != 0) {
               field2651[var7] = var4.method8212();
            } else {
               field2651[var7] = var11;
            }

            if ((var9 & 4) != 0) {
               field2652[var7] = var4.method8212();
            } else {
