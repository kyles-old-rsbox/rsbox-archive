...
public final class class246 {
   ...
   boolean field2865 = false;
   boolean field2874 = false;
   class243[][] field2869;
   class257 field2866;
   class473 field2870;
   class488[] field2867;
   ...
   public void method4892(class319 var1, String var2, boolean var3) {
      if (!this.field2865) {
         ...
         this.field2865 = true;
         System.nanoTime();
         int var5 = var1.method6116(class242.field2838.field2837);
         int var6 = var1.method6162(var5, var2);
         class460 var7 = new class460(var1.method6140(class242.field2838.field2837, var2));
         class460 var8 = new class460(var1.method6140(class242.field2833.field2837, var2));
         System.nanoTime();
         System.nanoTime();
         ...
         int var9 = this.field2866.method5059() - this.field2866.method5124() + 1;
         int var10 = this.field2866.method5061() - this.field2866.method5079() + 1;
         System.nanoTime();
         System.nanoTime();
         class243.method3411();
         this.field2869 = new class243[var9][var10];
         ...
         for(int var18 = 0; var18 < var9; ++var18) {
            for(int var20 = 0; var20 < var10; ++var20) {
               if (null == this.field2869[var18][var20]) {
                  this.field2869[var18][var20] = new class243(this.field2866.method5124() + var18, this.field2866.method5079() + var20, this.field2866.method5056(), this.field2872);
                  this.field2869[var18][var20].method4737(this.field2866.field2954, this.field2866.field2953);
               }
            }
         }
         ...
         System.nanoTime();
         System.nanoTime();
         if (var1.method6147(class242.field2832.field2837, var2)) {
            byte[] var19 = var1.method6140(class242.field2832.field2837, var2);
            this.field2870 = class32.method712(var19);
         }
   ...
   public final void method4894(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      ...
      class481.method8644(var10, var11, var12);
      class481.method8648(var13);
   ...
   public void method4896(int var1, int var2, int var3, int var4, HashSet var5, int var6, int var7) {
      if (null != this.field2870) {
         this.field2870.method8480(var1, var2, var3, var4);
         if (var6 > 0 && var6 % var7 < var7 / 2) {
            ...
            while(true) {
               ...
               while(var12.hasNext()) {
                  ...
                  class481.method8651(var14 + var1, var2 + var15, 2, 16776960, 256);
               }
            }
         }
      }
   ...
   public static boolean method4928(int var0) {
      if (class299.field3442[var0]) {
         return true;
      } else if (!class105.field1044.method6083(var0)) {
         return false;
      } else {
         int var2 = class105.field1044.method6091(var0);
         if (0 == var2) {
            ...
            for(int var3 = 0; var3 < var2; ++var3) {
               if (null == class300.field3593[var0][var3]) {
                  byte[] var4 = class105.field1044.method6167(var0, var3);
                  if (var4 != null) {
                     class300.field3593[var0][var3] = new class300();
                     class300.field3593[var0][var3].field3517 = var3 + (var0 << 16);
                     if (-1 == var4[0]) {
                        class300.field3593[var0][var3].method5840(new class460(var4));
                     } else {
                        class300.field3593[var0][var3].method5839(new class460(var4));
                     }
                  }
               }
            }
