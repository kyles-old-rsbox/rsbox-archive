public class class76 {
	...
	class76() {
		class60.method1323(24);
		this.field653 = class60.method1323(16);
		this.field657 = class60.method1323(24);
		...
		if (var1) {
			...
			for (var3 = class60.method1323(5) + 1; var2 < this.field657; ++var3) {
				int var4 = class60.method1323(class8.method51(this.field657 - var2));
			...
			boolean var14 = class60.method1299() != 0;

			for (var3 = 0; var3 < this.field657; ++var3) {
				if (var14 && class60.method1299() == 0) {
					this.field654[var3] = 0;
				} else {
					this.field654[var3] = class60.method1323(5) + 1;
				}
			}
		}

		this.method1560();
		var2 = class60.method1323(4);
		if (var2 > 0) {
			float var15 = class60.method1331(class60.method1323(32));
			float var16 = class60.method1331(class60.method1323(32));
			var5 = class60.method1323(4) + 1;
			boolean var6 = class60.method1299() != 0;
			int var7;
			if (var2 == 1) {
			...
			for (var8 = 0; var8 < var7; ++var8) {
				this.field655[var8] = class60.method1323(var5);
			}
	...
	int method1562() {
		int var1;
		for (var1 = 0; this.field652[var1] >= 0; var1 = class60.method1299() != 0 ? this.field652[var1] : var1 + 1) {
		}
