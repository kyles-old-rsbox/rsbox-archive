public class class113 {
   boolean field1114 = true;
   boolean field1115 = true;
   class412 field1116 = new class412();
   class412 field1117 = new class412();
   class412 field1120 = new class412();
   class412[] field1112;
   class412[] field1113;
   float[][] field1118;
   float[][] field1119;
   ...
   public class113(int var1, class460 var2, boolean var3) {
      this.field1109 = var2.method8197();
      ...
      for(int var4 = 0; var4 < this.field1111.length; ++var4) {
         ...
         this.field1122[var4][0] = var2.method8121();
         this.field1122[var4][1] = var2.method8121();
         this.field1122[var4][2] = var2.method8121();
      }
   ...
   class412 method2190(int var1) {
      if (null == this.field1112[var1]) {
         ...
         if (null != this.field1110) {
            this.field1112[var1].method7419(this.field1110.method2190(var1));
         } else {
            this.field1112[var1].method7419(class412.field4564);
         }
      }
   ...
   class412 method2175(int var1) {
      if (null == this.field1113[var1]) {
         ...
         this.field1113[var1].method7445();
      }
   ...
   void method2194(class412 var1) {
      this.field1120.method7415(var1);
      this.field1115 = true;
      this.field1114 = true;
   }
   ...
   class412 method2178() {
      if (this.field1115) {
         this.field1116.method7415(this.method2177());
         if (this.field1110 != null) {
            this.field1116.method7419(this.field1110.method2178());
         }
   ...
   public class412 method2179(int var1) {
      if (this.field1114) {
         this.field1117.method7415(this.method2175(var1));
         this.field1117.method7419(this.method2178());
