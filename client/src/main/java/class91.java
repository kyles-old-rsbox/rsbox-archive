public class class91 extends class427 {
   ...
   class158 field880;
   class350 field879 = new class350();
   ...
   void method1889(int var1, int var2, int var3, int var4) {
      ...
      for(class99 var8 = (class99)this.field879.method6457(); var8 != null; var8 = (class99)this.field879.method6459()) {
         ++var7;
      ...
      if (var6 == null) {
         if (var7 < 4) {
            this.field879.method6455(new class99(var1, var2, var3, var4));
         }

      } else {
         class350.method6468(new class99(var1, var2, var3, var4), var6);
         if (var7 >= 4) {
            this.field879.method6457().remove();
         }
   ...
   class99 method1896(int var1) {
      class99 var3 = (class99)this.field879.method6457();
      if (null != var3 && var3.field986 <= var1) {
         for(class99 var4 = (class99)this.field879.method6459(); var4 != null && var4.field986 <= var1; var4 = (class99)this.field879.method6459()) {
            var3.remove();
            var3 = var4;
         }
   ...
   boolean method1891() {
      return this.field879.method6524();
   }
