public class class186 extends class427 {
   ...
   class186(class460 var1) {
      this.field1965 = var1.method8115();
      this.field1966 = var1.method8134() == 1;
      ...
      if (var2 >= 1 && var2 <= 4) {
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            this.field1967[var3] = var1.method8115();
         }
         ...
         if (var2 > 1) {
            ...
            for(var3 = 0; var3 < var2 - 1; ++var3) {
               this.field1963[var3] = var1.method8134();
            }
         }
         ...
         if (var2 > 1) {
            ...
            for(var3 = 0; var3 < var2 - 1; ++var3) {
               this.field1969[var3] = var1.method8134();
            }
         }
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            this.field1968[var3] = var1.method8119();
         }

         this.field1971 = var1.method8134();
         this.field1972 = var1.method8134();
         this.field1973 = null;
      } else {
   ...
   boolean method3437(double var1, int var3, class319 var4) {
      ...
      for(var5 = 0; var5 < this.field1967.length; ++var5) {
         if (var4.method6088(this.field1967[var5]) == null) {
            return false;
         }
      }
      ...
      for(int var6 = 0; var6 < this.field1967.length; ++var6) {
         class488 var7 = class412.method7408(var4, this.field1967[var6]);
         var7.method8746();
