...
public class class466 {
   ...
   public class466(class464 var1, int var2, int var3) throws IOException {
      this.field4914 = var1;
      this.field4912 = this.field4916 = var1.method8366();
      this.field4909 = new byte[var2];
      this.field4907 = new byte[var3];
      this.field4915 = 0L;
   }

   public void method8390() throws IOException {
      this.method8392();
      this.field4914.method8367();
   }

   public void method8386(long var1) throws IOException {
      if (var1 < 0L) {
   ...
   public long method8387() {
      return this.field4912;
   }

   public void method8384(byte[] var1) throws IOException {
      this.method8385(var1, 0, var1.length);
   }

   public void method8385(byte[] var1, int var2, int var3) throws IOException {
      try {
         ...
         if (var3 > this.field4909.length) {
            this.field4914.method8372(this.field4915);

            for(this.field4918 = this.field4915; var3 > 0; var3 -= var9) {
               var9 = this.field4914.method8362(var1, var2, var3);
               if (var9 == -1) {
                  break;
               }
         ...
         if (-1L != this.field4913) {
            ...
            if (var15 > -1L && var11 > var15) {
               ...
               System.arraycopy(this.field4907, (int)(var15 - this.field4913), var1, (int)(var15 - var5) + var2, var13);
   ...
   void method8403() throws IOException {
      this.field4911 = 0;
      ...
      for(this.field4910 = this.field4915; this.field4911 < this.field4909.length; this.field4911 += var3) {
         ...
         var3 = this.field4914.method8362(this.field4909, this.field4911, var2);
         if (var3 == -1) {
            break;
         }
   ...
   public void method8391(byte[] var1, int var2, int var3) throws IOException {
      try {
         ...
         if (var3 <= this.field4907.length) {
            ...
            this.field4914.method8363(var1, var2, var3);
            this.field4918 += (long)var3;
            ...
            if (var11 > -1L && var7 > var11) {
               ...
               System.arraycopy(var1, (int)(var11 + (long)var2 - this.field4915), this.field4909, (int)(var11 - this.field4910), var9);
            }
   ...
   void method8392() throws IOException {
      if (this.field4913 != -1L) {
         if (this.field4918 != this.field4913) {
            this.field4914.method8372(this.field4913);
            this.field4918 = this.field4913;
         }

         this.field4914.method8363(this.field4907, 0, this.field4917);
