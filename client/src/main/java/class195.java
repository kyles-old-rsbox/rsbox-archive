public class class195 extends class437 {
   ...
   public static class284 field2056 = new class284(500);
   public static class319 field2053;
   public static class319 field2054;
   static class201[] field2059 = new class201[4];
   static class284 field2055 = new class284(4096);
   static class284 field2058 = new class284(30);
   static class284 field2074 = new class284(30);
   ...
   void method3581(class460 var1, int var2) {
      ...
      if (1 == var2) {
         ...
         if (var4 > 0) {
            if (null != this.field2057 && !field2082) {
               ...
               for(var5 = 0; var5 < var4; ++var5) {
                  this.field2057[var5] = var1.method8115();
                  this.field2079[var5] = var1.method8134();
               }
            }
         }
      } else if (var2 == 2) {
         this.field2063 = var1.method8124();
      } else if (5 == var2) {
         var4 = var1.method8134();
         if (var4 > 0) {
            if (null != this.field2057 && !field2082) {
         ...
         this.field2100 = var1.method8134();
      } else if (var2 == 15) {
         this.field2069 = var1.method8134();
      } else if (var2 == 17) {
         this.field2070 = 0;
         ...
         this.field2072 = var1.method8134();
      } else if (var2 == 21) {
         this.field2073 = 0;
      } else if (22 == var2) {
         this.field2065 = true;
         ...
         this.field2076 = var1.method8115();
         ...
         this.field2077 = var1.method8134();
      } else if (29 == var2) {
         this.field2061 = var1.method8280();
      } else if (var2 == 39) {
         this.field2078 = var1.method8280() * 25;
      } else if (var2 >= 30 && var2 < 35) {
         this.field2060[var2 - 30] = var1.method8124();
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field2064[var5] = (short)var1.method8115();
            this.field2092[var5] = (short)var1.method8115();
         }
      } else if (var2 == 41) {
         var4 = var1.method8134();
         ...
         for(var5 = 0; var5 < var4; ++var5) {
            this.field2066[var5] = (short)var1.method8115();
            this.field2067[var5] = (short)var1.method8115();
         }
      } else if (var2 == 61) {
         var1.method8115();
      } else if (var2 == 62) {
         ...
         this.field2080 = var1.method8115();
      } else if (66 == var2) {
         this.field2062 = var1.method8115();
      } else if (var2 == 67) {
         this.field2087 = var1.method8115();
      } else if (68 == var2) {
         this.field2075 = var1.method8115();
      } else if (var2 == 69) {
         var1.method8134();
      } else if (var2 == 70) {
         this.field2088 = var1.method8197();
      } else if (var2 == 71) {
         this.field2089 = var1.method8197();
      } else if (72 == var2) {
         this.field2090 = var1.method8197();
      } else if (var2 == 73) {
         this.field2068 = true;
      } else if (74 == var2) {
         this.field2085 = true;
      } else if (75 == var2) {
         this.field2093 = var1.method8134();
      } else if (var2 != 77 && 92 != var2) {
         if (78 == var2) {
            this.field2097 = var1.method8115();
            this.field2098 = var1.method8134();
         } else if (79 == var2) {
            this.field2086 = var1.method8115();
            this.field2102 = var1.method8115();
            this.field2098 = var1.method8134();
            var4 = var1.method8134();
            this.field2101 = new int[var4];

            for(var5 = 0; var5 < var4; ++var5) {
               this.field2101[var5] = var1.method8115();
            }
         } else if (var2 == 81) {
            this.field2073 = var1.method8134() * 256;
         } else if (var2 == 82) {
            this.field2081 = var1.method8115();
         } else if (89 == var2) {
         ...
         this.field2095 = var1.method8115();
         if (this.field2095 == 65535) {
            this.field2095 = -1;
         }

         this.field2096 = var1.method8115();
         ...
         for(int var6 = 0; var6 <= var5; ++var6) {
            this.field2094[var6] = var1.method8115();
      ...
      if (null != this.field2079) {
         for(int var5 = 0; var5 < this.field2079.length; ++var5) {
            if (var1 == this.field2079[var5]) {
               return field2054.method6081(this.field2057[var5] & '\uffff', 0);
            }
         }
         ...
         for(int var4 = 0; var4 < this.field2057.length; ++var4) {
            var3 &= field2054.method6081(this.field2057[var4] & '\uffff', 0);
         }
   ...
   public final boolean method3587() {
      if (this.field2057 == null) {
         ...
         for(int var3 = 0; var3 < this.field2057.length; ++var3) {
            var2 &= field2054.method6081(this.field2057[var3] & '\uffff', 0);
         }
   ...
   final class201 method3579(int var1, int var2) {
      ...
      if (null == this.field2079) {
         ...
         for(int var7 = 0; var7 < var6; ++var7) {
            ...
            if (null == var4) {
               var4 = class201.method3774(field2054, var8 & '\uffff', 0);
               if (var4 == null) {
                  return null;
               }
         ...
         var6 = this.field2057[var9];
         boolean var10 = this.field2083 ^ var2 > 3;
         if (var10) {
            var6 += 65536;
         }
         ...
         if (var4 == null) {
            var4 = class201.method3774(field2054, var6 & '\uffff', 0);
            if (var4 == null) {
               return null;
            }
      ...
      class201 var12 = new class201(var4, 0 == var2 && !var5 && !var11, this.field2064 == null, this.field2066 == null, true);
      if (4 == var1 && var2 > 3) {
         var12.method3788(256);
         var12.method3822(45, 0, -45);
      }
      ...
      if (null != this.field2064) {
         for(var8 = 0; var8 < this.field2064.length; ++var8) {
            var12.method3790(this.field2064[var8], this.field2092[var8]);
         }
      }

      if (null != this.field2066) {
         for(var8 = 0; var8 < this.field2066.length; ++var8) {
            var12.method3791(this.field2066[var8], this.field2067[var8]);
         }
      }

      if (var5) {
         var12.method3776(this.field2080, this.field2062, this.field2087);
      }

      if (var11) {
         var12.method3822(this.field2088, this.field2089, this.field2090);
      }
   ...
   public int method3614(int var1, int var2) {
      return class353.method6562(this.field2103, var1, var2);
   }

   public String method3590(int var1, String var2) {
      return class369.method6727(this.field2103, var1, var2);
   }
