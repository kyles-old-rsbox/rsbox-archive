	...
	static final void method5224(int var0, int var1, int var2, int var3, class473 var4, class298 var5) {
		if (null != var4) {
			...
			if (var8 <= 6400) {
				...
				if (var8 > 2500) {
					var4.method8501(var11 + var5.field3435 / 2 - var4.field4956 / 2, var5.field3433 / 2 - var12 - var4.field4957 / 2, var0, var1, var5.field3435, var5.field3433, var5.field3432, var5.field3434);
				} else {
					var4.method8526(var11 + var5.field3435 / 2 + var0 - var4.field4956 / 2, var1 + var5.field3433 / 2 - var12 - var4.field4957 / 2);
				}
