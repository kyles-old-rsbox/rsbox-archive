...
public abstract class class115 implements Runnable {
	...
	int field1131;
	Queue field1133;
	final Thread field1130;
	volatile boolean field1129;

	class115(int var1) {
		this.field1133 = new LinkedList();
		this.field1130 = new Thread(this);
	...
	public static void method2229(String var0, boolean var1, boolean var2) {
		if (var1) {
			...
			if (class30.field157.startsWith("win") && !var2) {
				class411.method7411(var0, 0, "openjs");
			} else if (class30.field157.startsWith("mac")) {
				class411.method7411(var0, 1, "openjs");
			} else {
				class411.method7411(var0, 2, "openjs");
			}
		} else {
			class411.method7411(var0, 3, "openjs");
		}
