public class class86 {
   ...
   void method1832() {
      ...
      for(var2 = 0; var2 < 64; ++var2) {
         this.field775[var2 + 64] = var2 * 4 + '\uff00';
      }

      for(var2 = 0; var2 < 64; ++var2) {
         this.field775[128 + var2] = '\uffff' + var2 * 262144;
      }
      ...
      this.field767 = 0;
      this.field772 = new int['\u8000'];
      this.field773 = new int['\u8000'];
      this.method1824((class488)null);
      this.field763 = new int['\u8000'];
      this.field771 = new int['\u8000'];
   }
      ...
      for(int var4 = 1; var4 < 255; ++var4) {
         ...
         for(int var10 = var7; var10 < var8; ++var10) {
            ...
            if (0 != var11 && var12 >= class481.field4997 && var12 < class481.field4996) {
               ...
               class6.field18.field4980[var9++] = -16777216 | ((var11 & 16711935) * var13 + (var15 & 16711935) * var14 & -16711936) + (var14 * (var15 & '\uff00') + var13 * (var11 & '\uff00') & 16711680) >> 8;
            } else {
               ++var9;
            }
         }
   ...
   static class218 method1819(int var0) {
      ...
      if (var2 != null) {
         ...
         boolean var6 = true;
         int[] var7 = var4.method6090(var0);

         for(int var8 = 0; var8 < var7.length; ++var8) {
            byte[] var9 = var4.method6123(var0, var7[var8]);
            if (var9 == null) {
               var6 = false;
            } else {
               int var10 = (var9[0] & 255) << 8 | var9[1] & 255;
               byte[] var11 = var5.method6123(var10, 0);
               if (var11 == null) {
                  var6 = false;
               }
            }
