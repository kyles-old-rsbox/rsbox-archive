...
public abstract class class31 extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   protected static class36 field198 = new class36();
   protected static int field174 = 0;
   public static int field193;
   static boolean field170 = false;
   static class31 field201 = null;
   static int field168 = 0;
   static int field173 = 1;
   static int field183 = 500;
   static int field188 = 20;
   static long field166 = 0L;
   static long field199 = -1L;
   static long field200 = -1L;
   static long[] field167 = new long[32];
   static long[] field176 = new long[32];
   static volatile boolean field197 = true;
   boolean field178 = false;
   boolean field191 = false;
   class5 field194;
   int field180 = 0;
   int field181 = 0;
   int field184;
   ...
   volatile boolean field189 = true;
   volatile boolean field192 = false;
   volatile long field172 = 0L;
   ...
   static class78 method597(byte[] var0) {
      ...
      int var4 = var3.method8115();
      int var5 = var3.field4881.length - 2 - var4 - 12;
      var3.field4878 = var5;
      int var6 = var3.method8119();
      var2.field677 = var3.method8115();
      var2.field678 = var3.method8115();
      var2.field679 = var3.method8115();
      var2.field672 = var3.method8115();
      int var7 = var3.method8134();
      int var8;
      int var9;
      if (var7 > 0) {
         ...
         for(var8 = 0; var8 < var7; ++var8) {
            var9 = var3.method8115();
            class421 var10 = new class421(var9 > 0 ? class282.method953(var9) : 1);
            var2.field681[var8] = var10;

            while(var9-- > 0) {
               int var11 = var3.method8119();
               int var12 = var3.method8119();
               var10.method7774(new class426(var12), (long)var11);
            }
         }
      }

      var3.field4878 = 0;
      var2.field673 = var3.method8298();
      ...
      for(var8 = 0; var3.field4878 < var5; var2.field674[var8++] = var9) {
         var9 = var3.method8115();
         if (3 == var9) {
            var2.field676[var8] = var3.method8124();
         } else if (var9 < 100 && var9 != 21 && var9 != 38 && var9 != 39) {
            var2.field680[var8] = var3.method8119();
         } else {
            var2.field680[var8] = var3.method8134();
         }
      }
   ...
   public void run() {
      try {
         if (null != class172.field1559) {
            ...
            if (var1.indexOf("sun") != -1 || var1.indexOf("apple") != -1) {
               ...
               if (var2.startsWith("1.6.0_")) {
                  int var3;
                  for(var3 = 6; var3 < var2.length() && class347.method6414(var2.charAt(var3)); ++var3) {
                  }
         ...
         class422.method7800((String)null, var6);
         this.method473("crash");
      }
   ...
   static final void method506(String var0) {
      ...
      var2.field2984.method8097(var0.length() + 1);
