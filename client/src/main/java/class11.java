...
public final class class11 extends Canvas {
   ...
   static int method84(int var0, class78 var1, boolean var2) {
      ...
      if (var0 == 100) {
         ...
         int var12 = class57.field404[class387.field4452 + 2];
         if (0 == var5) {
            throw new RuntimeException();
         } else {
            class300 var7 = class282.method5426(var4);
            if (null == var7.field3602) {
               var7.field3602 = new class300[1 + var12];
            }

            if (var7.field3602.length <= var12) {
               class300[] var8 = new class300[1 + var12];
            ...
            if (var12 > 0 && var7.field3602[var12 - 1] == null) {
               ...
               var13.field3484 = var12;
               var13.field3459 = true;
               if (var5 == 12) {
                  var13.method5913();
                  var13.method5869().method5599(new class92(var13));
                  var13.method5869().method5598(new class100(var13));
               }

               var7.field3602[var12] = var13;
               if (var2) {
         ...
         if (var0 == 101) {
            ...
            var4 = class57.field404[class387.field4452];
            var5 = class57.field404[1 + class387.field4452];
            class300 var6 = class253.method5043(var4, var5);
            if (var6 != null && -1 != var5) {
               class57.field404[++class387.field4452 - 1] = 1;
               if (var2) {
                  class138.field1284 = var6;
               } else {
                  class153.field1414 = var6;
               }
            } else {
               class57.field404[++class387.field4452 - 1] = 0;
            }
