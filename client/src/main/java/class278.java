public class class278 extends class51 {
   ...
   boolean field3184;
   class277 field3189 = new class277();
   class296[][] field3187 = new class296[16][128];
   class296[][] field3188 = new class296[16][128];
   class299 field3173 = new class299(this);
   class434 field3171 = new class434(128);
   int field3170 = 256;
   int field3175;
   int field3192;
   int field3195 = 1000000;
   int[] field3169 = new int[16];
   int[] field3172 = new int[16];
   int[] field3174 = new int[16];
   int[] field3176 = new int[16];
   int[] field3178 = new int[16];
   int[] field3179 = new int[16];
   int[] field3180 = new int[16];
   int[] field3181 = new int[16];
   int[] field3182 = new int[16];
   int[] field3183 = new int[16];
   int[] field3185 = new int[16];
   int[] field3186 = new int[16];
   int[] field3190 = new int[16];
   int[] field3191 = new int[16];
   int[] field3196 = new int[16];
   long field3193;
   long field3194;
   ...
   public synchronized boolean loadMusicTrack(class292 var1, class319 var2, SoundCache var3, int var4) {
      var1.method5492();
      boolean var6 = true;
      int[] var7 = null;
      if (var4 > 0) {
      ...
      for(class440 var8 = (class440)var1.field3367.method7860(); var8 != null; var8 = (class440)var1.field3367.method7851()) {
         int var9 = (int)var8.field4681;
         class288 var10 = (class288)this.field3171.get((long)var9);
         if (null == var10) {
            byte[] var12 = var2.method6095(var9);
            class288 var11;
            if (var12 == null) {
               var11 = null;
            } else {
            ...
            this.field3171.put(var11, (long)var9);
         }
   ...
   public static class198 method5388(int var0) {
      ...
      if (var2 != null) {
         ...
         byte[] var3 = class298.field3438.method6167(10, var0);
         var2 = new class198();
         var2.field2129 = var0;
         if (var3 != null) {
         ...
         if (!class6.field16 && var2.field2162) {
            ...
            if (null != var2.field2174) {
               ...
               for(class427 var5 = var2.field2174.method7780(); null != var5; var5 = var2.field2174.method7782()) {
   ...
   public synchronized void method5277() {
      for(class288 var2 = (class288)this.field3171.method7860(); null != var2; var2 = (class288)this.field3171.method7851()) {
         var2.method5454();
      }
   ...
   synchronized void method5275() {
      for(class288 var2 = (class288)this.field3171.method7860(); var2 != null; var2 = (class288)this.field3171.method7851()) {
         var2.remove();
      }
   ...
   void method5281(int var1, int var2, int var3) {
      ...
      if (0 != (this.field3181[var1] & 2)) {
         for(class296 var5 = (class296)this.field3173.field3440.method6355(); var5 != null; var5 = (class296)this.field3173.field3440.method6370()) {
      ...
      class288 var9 = (class288)this.field3171.get((long)this.field3176[var1]);
      if (var9 != null) {
         ...
         if (var10 != null) {
            ...
            var7.field3381 = var1;
            var7.field3380 = var9;
            var7.field3387 = var10;
            var7.field3394 = var9.field3352[var2];
            var7.field3379 = var9.field3353[var2];
            var7.field3384 = var2;
            var7.field3385 = var9.field3350[var2] * var9.field3356 * var3 * var3 + 1024 >> 11;
            var7.field3386 = var9.field3351[var2] & 255;
            var7.field3396 = (var2 << 8) - (var9.field3349[var2] & 32767);
            var7.field3390 = 0;
            var7.field3399 = 0;
            var7.field3392 = 0;
            var7.field3393 = -1;
            ...
            if (this.field3196[var1] == 0) {
               var7.field3397 = class44.method811(var10, this.method5293(var7), this.method5294(var7), this.method5295(var7));
            } else {
               var7.field3397 = class44.method811(var10, this.method5293(var7), 0, this.method5295(var7));
               this.method5385(var7, var9.field3349[var2] < 0);
            }

            if (var9.field3349[var2] < 0) {
            ...
            this.field3173.field3440.method6347(var7);
   ...
   void method5282(int var1, int var2, int var3) {
      ...
      if (var5 != null) {
         ...
         if (0 != (this.field3181[var1] & 2)) {
            for(class296 var6 = (class296)this.field3173.field3440.method6356(); var6 != null; var6 = (class296)this.field3173.field3440.method6350()) {
   ...
   void method5302(int var1) {
      for(class296 var3 = (class296)this.field3173.field3440.method6356(); var3 != null; var3 = (class296)this.field3173.field3440.method6350()) {
         if (var1 < 0 || var3.field3381 == var1) {
            if (null != var3.field3397) {
               var3.field3397.method815(SoundCache.field348 / 100);
   ...
   void method5291(int var1) {
      for(class296 var3 = (class296)this.field3173.field3440.method6356(); null != var3; var3 = (class296)this.field3173.field3440.method6350()) {
   ...
   int method5293(class296 var1) {
      ...
      var5 = (int)((double)(var1.field3387.field257 * 256) * Math.pow(2.0D, (double)var3 * 3.255208333333333E-4D) / (double) SoundCache.field348 + 0.5D);
   ...
   protected synchronized void method1005(int[] var1, int var2, int var3) {
      if (this.field3189.method5228()) {
         int var4 = this.field3195 * this.field3189.field3168 / SoundCache.field348;
   ...
   protected synchronized void method1001(int var1) {
      if (this.field3189.method5228()) {
         int var2 = this.field3195 * this.field3189.field3168 / SoundCache.field348;
   ...
   boolean method5301(class296 var1, int[] var2, int var3, int var4) {
      var1.field3398 = SoundCache.field348 / 100;
