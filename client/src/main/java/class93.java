public final class class93 extends class90 {
   ...
   final void method1906(class460 var1) {
      ...
      int var4 = -1;
      this.field894 = var1.method8280();
      this.field893 = var1.method8280();
      int var5 = -1;
      this.field921 = 0;
      int[] var6 = new int[12];
      ...
      super.field823 = var1.method8115();
      if (super.field823 == 65535) {
         super.field823 = -1;
      }

      super.field808 = var1.method8115();
      if (super.field808 == 65535) {
         super.field808 = -1;
      }

      super.field806 = super.field808;
      super.field810 = var1.method8115();
      if (65535 == super.field810) {
         super.field810 = -1;
      }

      super.field811 = var1.method8115();
      if (65535 == super.field811) {
         super.field811 = -1;
      }

      super.field812 = var1.method8115();
      if (super.field812 == 65535) {
         super.field812 = -1;
      }

      super.field813 = var1.method8115();
      if (super.field813 == 65535) {
         super.field813 = -1;
      }

      super.field814 = var1.method8115();
      if (super.field814 == 65535) {
         super.field814 = -1;
      }

      this.field910 = new class472(var1.method8124(), class234.field2779);
      this.method1908();
      this.method1913();
      this.method1911();
      if (class291.field3364 == this) {
         class487.field5013 = this.field910.method8444();
      }

      this.field905 = var1.method8134();
      this.field912 = var1.method8115();
      this.field913 = var1.method8134() == 1;
      ...
      for(var11 = 0; var11 < 3; ++var11) {
         this.field897[var11] = var1.method8124();
      }
      ...
      this.field911.method5989(var6, var27, var28, var26, var3, var5, var4);
   }
   ...
   void method1912() {
      this.field917 = null != class73.field603 && class73.field603.method7352(this.field910) ? class410.field4551 : class410.field4552;
   }

   void method1910() {
      for(int var2 = 0; var2 < 4; ++var2) {
         if (null != client.field1738[var2] && client.field1738[var2].method2525(this.field910.method8444()) != -1 && var2 != 2) {
   ...
   protected final class209 method4112() {
      if (this.field911 == null) {
         ...
         class209 var4 = this.field911.method5995(var2, super.field844, var3, super.field840);
         if (var4 == null) {
            return null;
         } else {
            var4.method4067();
                     ...
                     if (var17 >= 128) {
                        ...
                        if (var11 == 1) {
                           ...
                           while(true) {
                              ...
                              var30 = 1 + class191.field2020[var38][var39];
                              if (var38 > 0 && 0 == class191.field2023[var38 - 1][var39] && 0 == (var27[var28 - 1][var29] & 19136776)) {
                                 class191.field2017[var41] = var19 - 1;
                                 class191.field2021[var41] = var20;
                                 var41 = var41 + 1 & 4095;
                                 class191.field2023[var38 - 1][var39] = 2;
                                 class191.field2020[var38 - 1][var39] = var30;
                              }

                              if (var38 < 127 && 0 == class191.field2023[1 + var38][var39] && (var27[1 + var28][var29] & 19136896) == 0) {
                                 class191.field2017[var41] = var19 + 1;
                                 class191.field2021[var41] = var20;
                                 var41 = var41 + 1 & 4095;
                                 class191.field2023[var38 + 1][var39] = 8;
                                 class191.field2020[1 + var38][var39] = var30;
                              }

                              if (var39 > 0 && class191.field2023[var38][var39 - 1] == 0 && (var27[var28][var29 - 1] & 19136770) == 0) {
                                 class191.field2017[var41] = var19;
                                 class191.field2021[var41] = var20 - 1;
                                 var41 = var41 + 1 & 4095;
                                 class191.field2023[var38][var39 - 1] = 1;
                                 class191.field2020[var38][var39 - 1] = var30;
                              }

                              if (var39 < 127 && 0 == class191.field2023[var38][1 + var39] && (var27[var28][1 + var29] & 19136800) == 0) {
                                 class191.field2017[var41] = var19;
                                 class191.field2021[var41] = 1 + var20;
                                 var41 = var41 + 1 & 4095;
                                 class191.field2023[var38][1 + var39] = 4;
                                 class191.field2020[var38][var39 + 1] = var30;
                              }

                              if (var38 > 0 && var39 > 0 && 0 == class191.field2023[var38 - 1][var39 - 1] && 0 == (var27[var28 - 1][var29 - 1] & 19136782) && 0 == (var27[var28 - 1][var29] & 19136776) && (var27[var28][var29 - 1] & 19136770) == 0) {
                                 class191.field2017[var41] = var19 - 1;
                                 class191.field2021[var41] = var20 - 1;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 - 1][var39 - 1] = 3;
                                 class191.field2020[var38 - 1][var39 - 1] = var30;
                              }

                              if (var38 < 127 && var39 > 0 && class191.field2023[1 + var38][var39 - 1] == 0 && 0 == (var27[var28 + 1][var29 - 1] & 19136899) && (var27[1 + var28][var29] & 19136896) == 0 && 0 == (var27[var28][var29 - 1] & 19136770)) {
                                 class191.field2017[var41] = var19 + 1;
                                 class191.field2021[var41] = var20 - 1;
                                 var41 = var41 + 1 & 4095;
                                 class191.field2023[var38 + 1][var39 - 1] = 9;
                                 class191.field2020[1 + var38][var39 - 1] = var30;
                              }

                              if (var38 > 0 && var39 < 127 && 0 == class191.field2023[var38 - 1][var39 + 1] && 0 == (var27[var28 - 1][var29 + 1] & 19136824) && (var27[var28 - 1][var29] & 19136776) == 0 && (var27[var28][var29 + 1] & 19136800) == 0) {
                                 class191.field2017[var41] = var19 - 1;
                                 class191.field2021[var41] = 1 + var20;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 - 1][var39 + 1] = 6;
                                 class191.field2020[var38 - 1][var39 + 1] = var30;
                              }

                              if (var38 < 127 && var39 < 127 && class191.field2023[1 + var38][1 + var39] == 0 && (var27[1 + var28][var29 + 1] & 19136992) == 0 && 0 == (var27[1 + var28][var29] & 19136896) && 0 == (var27[var28][var29 + 1] & 19136800)) {
                                 class191.field2017[var41] = var19 + 1;
                                 class191.field2021[var41] = 1 + var20;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 + 1][1 + var39] = 12;
                                 class191.field2020[var38 + 1][1 + var39] = var30;
                              }
                           }
                           ...
                           while(true) {
                              ...
                              var30 = 1 + class191.field2020[var38][var39];
                              if (var38 > 0 && 0 == class191.field2023[var38 - 1][var39] && (var27[var28 - 1][var29] & 19136782) == 0 && (var27[var28 - 1][var29 + 1] & 19136824) == 0) {
                                 class191.field2017[var41] = var19 - 1;
                                 class191.field2021[var41] = var20;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 - 1][var39] = 2;
                              ...
                              if (var38 < 126 && 0 == class191.field2023[1 + var38][var39] && 0 == (var27[2 + var28][var29] & 19136899) && (var27[2 + var28][1 + var29] & 19136992) == 0) {
                                 class191.field2017[var41] = 1 + var19;
                                 class191.field2021[var41] = var20;
                                 var41 = var41 + 1 & 4095;
                                 class191.field2023[var38 + 1][var39] = 8;
                                 class191.field2020[var38 + 1][var39] = var30;
                              ...
                              if (var39 > 0 && 0 == class191.field2023[var38][var39 - 1] && 0 == (var27[var28][var29 - 1] & 19136782) && 0 == (var27[var28 + 1][var29 - 1] & 19136899)) {
                                 class191.field2017[var41] = var19;
                                 class191.field2021[var41] = var20 - 1;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38][var39 - 1] = 1;
                              ...
                              if (var39 < 126 && 0 == class191.field2023[var38][1 + var39] && (var27[var28][var29 + 2] & 19136824) == 0 && (var27[var28 + 1][var29 + 2] & 19136992) == 0) {
                                 class191.field2017[var41] = var19;
                                 class191.field2021[var41] = var20 + 1;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38][1 + var39] = 4;
                              ...
                              if (var38 > 0 && var39 > 0 && 0 == class191.field2023[var38 - 1][var39 - 1] && (var27[var28 - 1][var29] & 19136830) == 0 && (var27[var28 - 1][var29 - 1] & 19136782) == 0 && 0 == (var27[var28][var29 - 1] & 19136911)) {
                                 class191.field2017[var41] = var19 - 1;
                                 class191.field2021[var41] = var20 - 1;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 - 1][var39 - 1] = 3;
                              ...
                              if (var38 < 126 && var39 > 0 && class191.field2023[var38 + 1][var39 - 1] == 0 && 0 == (var27[var28 + 1][var29 - 1] & 19136911) && 0 == (var27[2 + var28][var29 - 1] & 19136899) && 0 == (var27[var28 + 2][var29] & 19136995)) {
                                 class191.field2017[var41] = var19 + 1;
                                 class191.field2021[var41] = var20 - 1;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 + 1][var39 - 1] = 9;
                              ...
                              if (var38 > 0 && var39 < 126 && 0 == class191.field2023[var38 - 1][1 + var39] && 0 == (var27[var28 - 1][1 + var29] & 19136830) && (var27[var28 - 1][2 + var29] & 19136824) == 0 && 0 == (var27[var28][var29 + 2] & 19137016)) {
                                 class191.field2017[var41] = var19 - 1;
                                 class191.field2021[var41] = 1 + var20;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 - 1][var39 + 1] = 6;
                              ...
                              if (var38 < 126 && var39 < 126 && 0 == class191.field2023[var38 + 1][var39 + 1] && (var27[var28 + 1][var29 + 2] & 19137016) == 0 && 0 == (var27[var28 + 2][2 + var29] & 19136992) && 0 == (var27[2 + var28][var29 + 1] & 19136995)) {
                                 class191.field2017[var41] = 1 + var19;
                                 class191.field2021[var41] = 1 + var20;
                                 var41 = 1 + var41 & 4095;
                                 class191.field2023[var38 + 1][var39 + 1] = 12;
                                 class191.field2020[var38 + 1][var39 + 1] = var30;
                              }
                           }
                           ...
                           var36 = class37.method715(var7, var8, var11, var12, var14);
                        }
                        ...
                        label569: {
                           ...
                           var38 = class191.field2022;
                           if (!var36) {
                              var39 = Integer.MAX_VALUE;
                              var23 = Integer.MAX_VALUE;
                              byte var40 = 10;
                              var41 = var13.field2305;
                              var26 = var13.field2303;
                              int var42 = var13.field2307;
                              var28 = var13.field2308;

                              for(var29 = var41 - var40; var29 <= var40 + var41; ++var29) {
                                 for(var30 = var26 - var40; var30 <= var40 + var26; ++var30) {
                                    ...
                                    if (var31 >= 0 && var32 >= 0 && var31 < 128 && var32 < 128 && class191.field2020[var31][var32] < 100) {
                                       ...
                                       if (var29 < var41) {
                                          var33 = var41 - var29;
                                       } else if (var29 > var42 + var41 - 1) {
                                          var33 = var29 - (var42 + var41 - 1);
                                       }
                                       ...
                                       if (var35 < var39 || var35 == var39 && class191.field2020[var31][var32] < var23) {
                                          var39 = var35;
                              ...
                              if (Integer.MAX_VALUE == var39) {
                                 var10 = -1;
                                 break label569;
                              }
                           }

                           if (var7 == var20 && var38 == var8) {
                              var15[0] = var20;
                              var16[0] = var38;
                              var10 = 0;
                           } else {
                              ...
                              var39 = var22 + 1;
                              class191.field2021[var22] = var38;

                              for(var23 = var24 = class191.field2023[var20 - var18][var38 - var19]; var7 != var20 || var38 != var8; var23 = class191.field2023[var20 - var18][var38 - var19]) {
                                 if (var24 != var23) {
                                    var24 = var23;
                                    class191.field2017[var39] = var20;
                                    class191.field2021[var39++] = var38;
                                 }
                              ...
                              while(var39-- > 0) {
                                 var15[var41] = class191.field2017[var39];
                                 var16[var41++] = class191.field2021[var39];
                                 if (var41 >= var15.length) {
                                    break;
                                 }
                              }
   ...
   void method1919(int var1, int var2) {
      ...
      super.field827 = 128 * super.field861[0] + 64 * var4;
