...
public class class131 extends class140 {
   ...
   public static void method2400(class460 var0, int var1) {
      ...
      var3.field309 = var0.method8134();
      var3.field307 = var0.method8119();
      ...
      for(int var4 = 0; var4 < var3.field309; ++var4) {
         try {
            ...
            if (var5 != 0 && 1 != var5 && var5 != 2) {
               if (3 == var5 || var5 == 4) {
                  var6 = var0.method8124();
                  var7 = var0.method8124();
                  var8 = var0.method8134();
                  String[] var9 = new String[var8];

                  for(int var10 = 0; var10 < var8; ++var10) {
                     var9[var10] = var0.method8124();
                  }

                  String var26 = var0.method8124();
                  byte[][] var11 = new byte[var8][];
                  int var13;
                  if (3 == var5) {
                     for(int var12 = 0; var12 < var8; ++var12) {
                        var13 = var0.method8119();
                        var11[var12] = new byte[var13];
                        var0.method8326(var11[var12], 0, var13);
                     }
                  }
                  ...
                  for(var13 = 0; var13 < var8; ++var13) {
                     var27[var13] = class86.method1835(var9[var13]);
                  }

                  Class var28 = class86.method1835(var26);
      ...
      class45.field329.method6454(var3);
   }
   ...
   void method2467(class460 var1) {
      this.field1241 = var1.method8119();
      this.field1240 = var1.method8124();
   }
   ...
   static final void method2399(String var0, boolean var1) {
      if (client.field1762) {
         ...
         int var4 = 6 + var3;
         int var5 = 6 + var3;
         int var6 = class353.field4289.method6855(var0, 250);
         int var7 = class353.field4289.method6862(var0, 250) * 13;
         class481.method8653(var4 - var3, var5 - var3, var3 + var3 + var6, var3 + var7 + var3, 0);
         class481.method8657(var4 - var3, var5 - var3, var3 + var3 + var6, var3 + var7 + var3, 16777215);
         class353.field4289.method6863(var0, var4, var5, var6, var7, 16777215, -1, 1, 1, 0);
         class319.method6173(var4 - var3, var5 - var3, var3 + var6 + var3, var3 + var3 + var7);
         if (var1) {
