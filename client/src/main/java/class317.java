public class class317 {
	...
	static void method6080(byte[] var0) {
		...
		class475.field4968 = var2.method8122();
		...
		class475.field4967 = var2.method8122();
		class475.field4971 = var2.method8122();
		int var3 = (var2.method8141() & 255) + 1;

		int var4;
		for (var4 = 0; var4 < class475.field4968; ++var4) {
			class450.field4840[var4] = var2.method8122();
		}

		for (var4 = 0; var4 < class475.field4968; ++var4) {
			class315.field3720[var4] = var2.method8122();
		}

		for (var4 = 0; var4 < class475.field4968; ++var4) {
			class467.field4921[var4] = var2.method8122();
		}

		for (var4 = 0; var4 < class475.field4968; ++var4) {
			class475.field4966[var4] = var2.method8122();
		}
