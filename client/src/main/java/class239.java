...
public abstract class class239 {
   public static boolean field2817 = true;
   boolean field2822;
   boolean field2823;
   byte[][][] field2818;
   byte[][][] field2819;
   ...
   void method4650(class319 var1) {
      if (!this.method4649()) {
         byte[] var3 = var1.method6167(this.field2814, this.field2820);
         if (null != var3) {
   ...
   void method4653(int var1, int var2, class460 var3, int var4) {
      ...
      if (var6) {
         this.field2808[0][var1][var2] = field2817 ? (short)var3.method8115() : (short)var3.method8134();
      }

      this.field2816[0][var1][var2] = field2817 ? (short)var3.method8115() : (short)var3.method8134();
   }
   ...
   void method4654(int var1, int var2, class460 var3, int var4) {
      ...
      int var12;
      if (var7) {
         var9 = var3.method8134();

         for(var10 = 0; var10 < var9; ++var10) {
            int var11 = field2817 ? var3.method8115() : var3.method8134();
            if (var11 != 0) {
               this.field2808[var10][var1][var2] = (short)var11;
               var12 = var3.method8134();
      ...
      if (var8) {
         for(var9 = 0; var9 < var6; ++var9) {
            var10 = var3.method8134();
            if (0 != var10) {
               class253[] var15 = this.field2812[var9][var1][var2] = new class253[var10];

               for(var12 = 0; var12 < var10; ++var12) {
                  int var13 = var3.method8133();
                  int var14 = var3.method8134();
