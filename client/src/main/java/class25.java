public class class25 implements class360 {
   public static final class25 field122 = new class25(0, 0);
   ...
   static final void method341(class90 var0, int var1) {
      ...
      if (0 != var0.field870) {
         if (var0.field835 != -1) {
            Object var13 = null;
            var4 = class78.field683 ? 65536 : '\u8000';
            if (var0.field835 < var4) {
               var13 = client.field1902[var0.field835];
            } else if (var0.field835 >= var4) {
               var13 = client.field1763[var0.field835 - var4];
            }

            if (null != var13) {
               var5 = var0.field827 - ((class90)var13).field827;
               var6 = var0.field802 - ((class90)var13).field802;
               if (0 != var5 || var6 != 0) {
         ...
         if (0 != var12) {
            ...
            if (var12 > 1024) {
               ...
               if (!var0.field838 && var0.field839 == var0.field823 && (var0.field869 > 25 || var14)) {
                  if (-1 != var0.field808) {
   ...
   static final void method344(boolean var0, class453 var1) {
      ...
      int var8;
      if (!client.field1706) {
         int var3 = var1.method8195();
         var4 = var1.method8155();
         var5 = var1.method8115();
         class36.field238 = new int[var5][4];

         for(var6 = 0; var6 < var5; ++var6) {
            for(var7 = 0; var7 < 4; ++var7) {
               class36.field238[var6][var7] = var1.method8119();
            }
         }
         ...
         for(var6 = (var3 - 6) / 8; var6 <= (6 + var3) / 8; ++var6) {
            for(var7 = (var4 - 6) / 8; var7 <= (6 + var4) / 8; ++var7) {
               ...
               class136.field1271[var5] = class58.field417.method6116("m" + var6 + "_" + var7);
               class2.field1[var5] = class58.field417.method6116("l" + var6 + "_" + var7);
               ++var5;
            }
         }
         ...
         boolean var16 = var1.method8147() == 1;
         var4 = var1.method8115();
         var5 = var1.method8155();
         ...
         for(var7 = 0; var7 < 4; ++var7) {
            for(var8 = 0; var8 < 13; ++var8) {
               for(var9 = 0; var9 < 13; ++var9) {
                  var10 = var1.method8007(1);
                  if (var10 == 1) {
                     client.field1707[var7][var8][var9] = var1.method8007(26);
                  } else {
         ...
         for(var7 = 0; var7 < var6; ++var7) {
            for(var8 = 0; var8 < 4; ++var8) {
               class36.field238[var7][var8] = var1.method8119();
            }
         }
               ...
               for(var9 = 0; var9 < 13; ++var9) {
                  ...
                  if (var10 != -1) {
                     ...
                     if (-1 != var13) {
                        ...
                        var14 = var13 >> 8 & 255;
                        int var15 = var13 & 255;
                        class136.field1271[var6] = class58.field417.method6116("m" + var14 + "_" + var15);
                        class2.field1[var6] = class58.field417.method6116("l" + var14 + "_" + var15);
                        ++var6;
                     }
                  }
               }
