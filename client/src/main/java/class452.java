public class class452 extends class437 {
   public static class284 field4852 = new class284(64);
   ...
   public static void method6809(class319 var0) {
      field4853 = var0;
   }

   void method7981(class460 var1) {
      while(true) {
         ...
         this.method7989(var1, var3);
      }
   }

   public Object[] method7982(int var1) {
      return this.field4854 == null ? null : this.field4854[var1];
   }

   void method7989(class460 var1, int var2) {
      if (var2 == 3) {
         ...
         for(int var5 = var1.method8134(); var5 != 255; var5 = var1.method8134()) {
            ...
            for(int var8 = 0; var8 < var6; ++var8) {
               var7[var8] = var1.method8200();
            }

            Object[][] var17 = this.field4854;
            int var11 = var1.method8200();
            ...
            for(int var13 = 0; var13 < var11; ++var13) {
               for(int var14 = 0; var14 < var7.length; ++var14) {
                  ...
                  var12[var15] = var16.method7967(var1);
               }
            }
         ...
         this.field4855 = var1.method8135();
      }
