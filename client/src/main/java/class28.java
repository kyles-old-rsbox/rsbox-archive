public class class28 {
	...
	protected class28() {
		...
		this.field137 = true;
		this.field149 = 0;
		this.field150 = new class51[8];
		this.field151 = new class51[8];
	}
		...
		if (null != this.field136) {
			...
			try {
				...
				while (var2 > this.field139 + 5000L) {
					this.method382(256);
					this.field139 += (long)(256000 / class49.field348);
				}
	...
	final void method363(int[] var1, int var2) {
		...
		class386.method6969(var1, 0, var3);
		this.field149 -= var2;
		if (null != this.field147 && this.field149 <= 0) {
			this.field149 += class49.field348 >> 4;
