public final class class82 {
   static byte[][][] field714 = new byte[4][104][104];
   static byte[][][] field718;
   static int field724 = 99;
   static int field727 = (int)(Math.random() * 17.0D) - 8;
   static int field728 = (int)(Math.random() * 33.0D) - 16;
   static int[][] field717;
   static int[][][] field719 = new int[4][105][105];
   static short[][][] field716;
   static short[][][] field723;
   static final int[] field713 = new int[]{1, 0, -1, 0};
   static final int[] field715 = new int[]{1, -1, -1, 1};
   static final int[] field721 = new int[]{1, 2, 4, 8};
   static final int[] field722 = new int[]{16, 32, 64, 128};
   static final int[] field725 = new int[]{0, -1, 0, 1};
   static final int[] field726 = new int[]{-1, -1, 1, 1};
         ...
         while(true) {
            ...
            if (var4 == var17 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) {
               ...
               if (var22 > 0 && var23 > 0 && var22 < 103 && var23 < 103) {
                  ...
                  class458.method8083(var1, var22, var23, var11, var7 + var20 & 3, var19, var8, var25);
               }
            }
         }
      }
   ...
   static final int method6251(int var0, int var1, int var2) {
      int var4 = var0 / var2;
