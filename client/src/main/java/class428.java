public class class428 implements class436 {
   ...
   public class439 method7879() {
      ...
      String var27 = "";
      boolean var28 = false;
      return new class439(var2, var7, var8, var9, this.field4684, this.field4687, this.field4688, false, var11, var12, var13, 0, var14, var15, var16, var17, 0, 0, 0, 0, var18, var19, var24, 0, "", "");
   }

   void method7826(String var1) {
      if (var1.startsWith("1.")) {
         this.method7827(var1);
      } else {
         this.method7830(var1);
      }

   }

   void method7827(String var1) {
