public class class102 {
   static byte[] field1019 = new byte[2048];
   static class197[] field1010 = new class197[2048];
   static class460 field1021 = new class460(new byte[5000]);
   static class460[] field1011 = new class460[2048];
   static int field1007 = 0;
   static int field1012 = 0;
   static int field1017 = 0;
   static int[] field1013 = new int[2048];
   static int[] field1014 = new int[2048];
   static int[] field1015 = new int[2048];
   static int[] field1016 = new int[2048];
   static int[] field1018 = new int[2048];
   static int[] field1020 = new int[2048];
