public class class209 extends class212 {
   static boolean field2442 = true;
   static boolean[] field2420 = new boolean[6500];
   static boolean[] field2421 = new boolean[6500];
   static byte[] field2379 = new byte[1];
   static byte[] field2414 = new byte[1];
   static char[] field2429 = new char[6000];
   static char[][] field2430 = new char[6000][512];
   static class209 field2437 = new class209();
   static class209 field2452 = new class209();
   static class412 field2380 = new class412();
   static class412 field2381 = new class412();
   static class412 field2382 = new class412();
   static int field2377;
   static int field2439;
   static int field2441;
   static int[] field2386 = new int[10];
   static int[] field2399;
   static int[] field2400 = new int[2000];
   static int[] field2403 = new int[6500];
   static int[] field2408 = new int[6500];
   static int[] field2418 = new int[12];
   static int[] field2422 = new int[6500];
   static int[] field2426 = new int[6500];
   static int[] field2427 = new int[6500];
   static int[] field2431 = new int[12];
   static int[] field2433 = new int[2000];
   static int[] field2435 = new int[6500];
   static int[] field2436 = new int[10];
   static int[] field2438 = new int[10];
   static int[] field2445;
   static int[] field2446;
   static int[] field2451;
   static int[][] field2432 = new int[12][2000];
   byte field2376 = 0;
   byte[] field2387;
   byte[] field2394;
   byte[] field2396;
   ...
   int[][] field2448;
   short[] field2397;
   public boolean field2407 = false;
   ...
   void method4003(int var1, int[] var2, int var3, int var4, int var5) {
      ...
      if (var1 == 0) {
         ...
         for(var8 = 0; var8 < var6; ++var8) {
            int var18 = var2[var8];
            if (var18 < this.field2448.length) {
               int[] var19 = this.field2448[var18];
                  ...
                  if (var23 / var14 < class221.field2632) {
                     ...
                     if (var32 && var31) {
                        ...
                        if (field2442) {
                           ...
                           var36 = var28 - class221.field2634;
                     ...
                     int var47 = class221.field2634;
                     var48 = class221.field2620;
                     var36 = 0;
                     var37 = 0;
                     if (var1 != 0) {
                        var36 = field2445[var1];
                     ...
                     for(var38 = 0; var38 < this.field2383; ++var38) {
                        ...
                        if (var41 >= 50) {
                           field2422[var38] = var47 + var39 * class221.field2630 / var41;
                           field2435[var38] = var48 + var42 * class221.field2630 / var41;
                        } else {
   ...
   final void method4079(boolean var1, boolean var2, boolean var3, long var4) {
      if (this.field2411 < 6000) {
         ...
         if (this.field2394 == null) {
            for(var27 = this.field2411 - 1; var27 >= 0; --var27) {
               var28 = field2429[var27];
               if (var28 > 0) {
                  var29 = field2430[var27];
            ...
            for(var27 = this.field2411 - 1; var27 >= 0; --var27) {
               ...
               if (var28 > 0) {
                  ...
                  for(var10 = 0; var10 < var28; ++var10) {
                     ...
                     byte var31 = this.field2394[var30];
                     var13 = field2431[var31]++;
                     field2432[var31][var13] = var30;
                     if (var31 < 10) {
                        int[] var34 = field2418;
                        var34[var31] += var27;
                     } else if (var31 == 10) {
                        field2433[var13] = var27;
                     } else {
                        field2400[var13] = var27;
                     }
                  }
               }
            }
            ...
            if (field2431[1] > 0 || field2431[2] > 0) {
               var27 = (field2418[1] + field2418[2]) / (field2431[1] + field2431[2]);
            }
            ...
            for(var15 = 0; var15 < 10; ++var15) {
               while(var15 == 0 && var10 > var27) {
                  this.method4013(var32[var11++]);
                  if (var11 == var12 && var32 != field2432[11]) {
                     var11 = 0;
                     var12 = field2431[11];
                     var32 = field2432[11];
                     var33 = field2400;
               ...
               int[] var35 = field2432[var15];

               for(var18 = 0; var18 < var16; ++var18) {
                  this.method4013(var35[var18]);
               }
            }
      ...
      if (this.field2412 != null) {
         for(int var3 = 0; var3 < this.field2383; ++var3) {
            ...
            if (var4 != null && var4.length != 0) {
               ...
               field2380.method7414();

               for(int var6 = 0; var6 < var4.length; ++var6) {
                  int var7 = var4[var6];
                  class113 var8 = var1.method4344(var7);
                  if (var8 != null) {
                     field2381.method7447((float)var5[var6] / 255.0F);
                     field2382.method7415(var8.method2179(var2));
                     field2382.method7419(field2381);
                     field2380.method7440(field2382);
                  }
               }
