public final class class488 extends class481 {
	...
	public void method8754(int var1, int var2, int var3) {
	...
	public void method8755(int var1, int var2) {
		var1 += this.field5020;
		var2 += this.field5021;
		...
		if (var6 > 0 && var5 > 0) {
			method8762(class481.field4992, this.field5022, this.field5023, var4, var3, var6, var5, var7, var8);
		}
	}

	static void method8762(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		int var9 = -(var5 >> 2);
		var5 = -(var5 & 3);
	...
	public void method8757(int var1, int var2, int var3, int var4) {
		...
		method8758(class481.field4992, this.field5022, this.field5023, var7, var8, var13, var14, var3, var4, var11, var12, var5);
	}

	static void method8758(int[] var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
		int var12 = var3;
