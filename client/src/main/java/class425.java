...
public class class425 implements class419 {
   ...
   public class425(byte[] var1) throws UnsupportedEncodingException {
      this.method7808(var1);
   }

   void method7808(byte[] var1) throws UnsupportedEncodingException {
      String var3 = new String(var1, "UTF-8");
      this.method7815(var3);
   }

   void method7815(String var1) throws UnsupportedEncodingException {
      try {
         if (var1.charAt(0) == '{') {
