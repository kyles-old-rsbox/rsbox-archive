...
public class class353 implements class360 {
   ...
   static int method6562(class421 var0, int var1, int var2) {
      if (null == var0) {
         return var2;
      } else {
         class426 var4 = (class426)var0.method7781((long)var1);
         return var4 == null ? var2 : var4.field4680;
      }
   }

   static class353[] method6546() {
   ...
   public static class353 method6558(int var0) {
      return var0 >= 0 && var0 < field4297.length ? field4297[var0] : null;
   }

   public String toString() {
      return this.method6545().toLowerCase(Locale.ENGLISH);
   }

   static void method6560(int var0, int var1, int var2, boolean var3, int var4, boolean var5) {
      if (var0 < var1) {
         ...
         method6560(var0, var8 - 1, var2, var3, var4, var5);
         method6560(1 + var8, var1, var2, var3, var4, var5);
      }

   }

   static void method6559() {
      if (client.field1739) {
