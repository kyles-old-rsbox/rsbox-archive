...
public class class300 extends class427 {
	...
	static class284 field3453;
	static class284 field3455;
	static class284 field3538;
	static class284 field3554;
	...
	static {
		field3554 = new class284(200);
		field3453 = new class284(50);
		field3538 = new class284(20);
		field3455 = new class284(8);
		field3451 = new class366(10, class387.field4457);
		field3457 = new class366(10, class387.field4457);
		field3458 = false;
	}

	void method5847(class460 var1) {
		this.field3459 = false;
		this.field3462 = var1.method8141();
		this.field3463 = var1.method8141();
		this.field3464 = var1.method8122();
		this.field3469 = var1.method8204();
		this.field3470 = var1.method8204();
		this.field3486 = var1.method8122();
		this.field3472 = var1.method8122();
		this.field3612 = var1.method8141();
		this.field3596 = var1.method8122();
		...
		this.field3536 = var1.method8122();
		...
		if (var3 > 0) {
			...
			for (var4 = 0; var4 < var3; ++var4) {
				this.field3591[var4] = var1.method8141();
				this.field3592[var4] = var1.method8122();
			}
		}
		...
		if (var4 > 0) {
			...
			for (var5 = 0; var5 < var4; ++var5) {
				...
				for (var7 = 0; var7 < var6; ++var7) {
					this.field3613[var5][var7] = var1.method8122();
		...
		if (0 == this.field3462) {
			this.field3492 = var1.method8122();
			this.field3480 = var1.method8141() == 1;
		}
		...
		if (this.field3462 == 2) {
			...
			this.field3528 = var1.method8141();
			this.field3529 = var1.method8141();
			...
			for (var9 = 0; var9 < 20; ++var9) {
				int var10 = var1.method8141();
				if (var10 == 1) {
					this.field3530[var9] = var1.method8204();
					this.field3531[var9] = var1.method8204();
					this.field3526[var9] = var1.method8126();
				} else {
			...
			for (var9 = 0; var9 < 5; ++var9) {
				String var11 = var1.method8131();
				if (var11.length() > 0) {
					this.field3533[var9] = var11;
		...
		if (this.field3462 == 3) {
			this.field3489 = var1.method8141() == 1;
		}

		if (4 == this.field3462 || 1 == this.field3462) {
			this.field3525 = var1.method8141();
			this.field3572 = var1.method8141();
			this.field3524 = var1.method8141();
			this.field3521 = var1.method8122();
			if (this.field3521 == 65535) {
				this.field3521 = -1;
			}

			this.field3488 = var1.method8141() == 1;
		}

		if (4 == this.field3462) {
			this.field3522 = var1.method8131();
			this.field3523 = var1.method8131();
		}

		if (this.field3462 == 1 || this.field3462 == 3 || this.field3462 == 4) {
			this.field3485 = var1.method8126();
		}

		if (this.field3462 == 3 || 4 == this.field3462) {
			this.field3495 = var1.method8126();
			this.field3487 = var1.method8126();
			this.field3567 = var1.method8126();
		}

		if (5 == this.field3462) {
			this.field3560 = var1.method8126();
			this.field3496 = var1.method8126();
		}

		if (this.field3462 == 6) {
			this.field3504 = 1;
			this.field3505 = var1.method8122();
			if (this.field3505 == 65535) {
				this.field3505 = -1;
			}

			this.field3506 = 1;
			this.field3507 = var1.method8122();
			if (65535 == this.field3507) {
				this.field3507 = -1;
			}

			this.field3575 = var1.method8122();
			if (65535 == this.field3575) {
				this.field3575 = -1;
			}

			this.field3509 = var1.method8122();
			if (this.field3509 == 65535) {
				this.field3509 = -1;
			}

			this.field3562 = var1.method8122();
			this.field3601 = var1.method8122();
			this.field3513 = var1.method8122();
		}
		...
		if (this.field3462 == 7) {
			...
			this.field3488 = var1.method8141() == 1;
			this.field3485 = var1.method8126();
			this.field3528 = var1.method8204();
			this.field3529 = var1.method8204();
			var5 = var1.method8141();
			if (var5 == 1) {
				this.field3527 |= 1073741824;
			}
		...
		if (2 == this.field3463 || this.field3462 == 2) {
			this.field3515 = var1.method8131();
			this.field3594 = var1.method8131();
			var5 = var1.method8122() & 63;
			this.field3527 |= var5 << 11;
		}

		if (1 == this.field3463 || this.field3463 == 4 || 5 == this.field3463 || 6 == this.field3463) {
			this.field3595 = var1.method8131();
	...
	void method5848(class460 var1) {
		...
		this.field3486 = var1.method8122();
		if (9 == this.field3462) {
			this.field3472 = var1.method8204();
		} else {
			this.field3472 = var1.method8122();
		}

		this.field3508 = var1.method8287();
		this.field3468 = var1.method8287();
		this.field3465 = var1.method8287();
		this.field3466 = var1.method8287();
		this.field3596 = var1.method8122();
		if (65535 == this.field3596) {
			this.field3596 = -1;
		} else {
		...
		this.field3480 = var1.method8141() == 1;
		if (this.field3462 == 0) {
			this.field3483 = var1.method8122();
			this.field3492 = var1.method8122();
			this.field3539 = var1.method8141() == 1;
		}

		if (5 == this.field3462) {
			this.field3560 = var1.method8126();
			this.field3498 = var1.method8122();
			this.field3499 = var1.method8141() == 1;
			this.field3612 = var1.method8141();
			this.field3500 = var1.method8141();
			this.field3501 = var1.method8126();
			this.field3467 = var1.method8141() == 1;
			this.field3503 = var1.method8141() == 1;
		}
		...
		if (6 == this.field3462) {
			...
			this.field3510 = var1.method8204();
			this.field3548 = var1.method8204();
			this.field3601 = var1.method8122();
			this.field3513 = var1.method8122();
			this.field3514 = var1.method8122();
			this.field3562 = var1.method8122();
			this.field3575 = var1.method8122();
			...
			this.field3534 = var1.method8141() == 1;
			var1.method8122();
			if (0 != this.field3508) {
				this.field3516 = var1.method8122();
			}
		...
		if (this.field3462 == 9) {
			this.field3493 = var1.method8141();
			this.field3485 = var1.method8126();
			this.field3494 = var1.method8141() == 1;
		}

		this.field3527 = var1.method8312();
		this.field3545 = var1.method8131();
		int var3 = var1.method8141();
		if (var3 > 0) {
			this.field3546 = new String[var3];

			for (int var4 = 0; var4 < var3; ++var4) {
				this.field3546[var4] = var1.method8131();
			}
		}

		this.field3600 = var1.method8141();
		this.field3604 = var1.method8141();
		this.field3550 = var1.method8141() == 1;
		this.field3515 = var1.method8131();
		this.field3553 = this.method5945(var1);
		this.field3558 = this.method5945(var1);
		this.field3454 = this.method5945(var1);
		this.field3598 = this.method5945(var1);
		this.field3563 = this.method5945(var1);
		this.field3565 = this.method5945(var1);
		this.field3585 = this.method5945(var1);
		this.field3569 = this.method5945(var1);
		this.field3571 = this.method5945(var1);
		this.field3549 = this.method5945(var1);
		this.field3559 = this.method5945(var1);
		this.field3611 = this.method5945(var1);
		this.field3555 = this.method5945(var1);
		this.field3556 = this.method5945(var1);
		this.field3557 = this.method5945(var1);
		this.field3478 = this.method5945(var1);
		this.field3537 = this.method5945(var1);
		this.field3574 = this.method5945(var1);
		this.field3566 = this.method5850(var1);
		this.field3568 = this.method5850(var1);
		this.field3570 = this.method5850(var1);
	}
	...
	public class473 method5852(boolean var1, class115 var2) {
		field3458 = false;
		if (this.field3497 != null) {
			class473 var4 = this.method5867(var2);
			if (var4 != null) {
				return var4;
			}
		}
		...
		if (-1 == var8) {
			...
			if (var7 != null) {
				...
				var7 = class389.method7014(class299.field3439, var8, 0);
				if (var7 == null) {
					field3458 = true;
					return null;
				} else {
					this.method5855(var7);
	...
	class473 method5867(class115 var1) {
		if (!this.method5854()) {
			return this.method5853(var1);
		} else {
			String var3 = this.field3497 + (this.field3467 ? 1 : 0) + (this.field3503 ? 1 : 0) + this.field3500 + this.field3501;
			class473 var4 = (class473)field3457.method6684(var3);
			if (null == var4) {
				class473 var5 = this.method5853(var1);
				if (var5 != null) {
					var4 = var5.method8474();
					this.method5855(var4);
					field3457.method6685(var3, var4);
				}
			}
	...
	class473 method5853(class115 var1) {
		if (null != this.field3497 && var1 != null) {
			class312 var3 = (class312)field3451.method6684(this.field3497);
			if (var3 == null) {
				var3 = new class312(this.field3497, var1);
				field3451.method6685(this.field3497, var3);
			}

			return var3.method6058();
		} else {
			return null;
		}
	}
	...
	void method5855(class473 var1) {
		...
		if (this.field3500 > 0) {
			var1.method8478(this.field3500);
		}
		...
		if (this.field3500 >= 2) {
			var1.method8518(16777215);
		}

		if (0 != this.field3501) {
			var1.method8482(this.field3501);
		}

	}

	public class376 method5856() {
		field3458 = false;
		if (this.field3521 == -1) {
			return null;
		} else {
			...
			if (var2 != null) {
				...
				var2 = class378.method6805(class299.field3439, class246.field2881, this.field3521, 0);
				if (null != var2) {
	...
	public class473 method5857(int var1) {
		field3458 = false;
		if (var1 >= 0 && var1 < this.field3526.length) {
			...
			if (-1 == var3) {
				...
				if (var4 != null) {
					...
					var4 = class389.method7014(class299.field3439, var3, 0);
					if (null != var4) {
	...
	public class209 method5858(class189 var1, int var2, boolean var3, class305 var4) {
		field3458 = false;
		int var6;
		int var7;
		if (var3) {
	...
	public class298 method5859(boolean var1) {
		if (this.field3496 == -1) {
			var1 = false;
		}
		...
		if (-1 == var3) {
			...
			if (var6 != null) {
				...
				class473 var7 = this.method5852(var1, (class115)null);
				if (var7 == null) {
					return null;
				} else {
					class473 var8 = var7.method8475();
	...
	public void method5860(int var1, String var2) {
	...
	public void method5863(String var1, class115 var2, long var3) {
	...
	public void method5866(String var1, int var2) {
	...
	public int method5868(String var1) {
		return 11 == this.field3462 && this.field3460 != null && this.method5876() ? this.field3460.method2760(var1) : -1;
	}

	public String method5937(String var1) {
		return this.field3462 == 11 && this.field3460 != null && this.method5876() ? this.field3460.method2761(var1) : null;
	}
	...
	public boolean method5874(class115 var1) {
		if (11 == this.field3462 && null != this.field3460) {
	...
	void method5931() {
		...
		for (var6 = var2.iterator(); var6.hasNext(); this.field3602[var5++] = var8) {
			...
			field3451.method6685(var8.field3497, var9);
		}
	...
	public boolean method5926() {
		class297 var2 = this.method5877();
		if (var2 == null) {
			return false;
		} else {
			boolean var3 = false;
			if (!var2.method5699() && this.field3521 != -1) {
				int var4 = var2.method5617();
				int var5 = var2.method5685();
				int var6 = var2.method5691();
				int var7 = var2.method5614();
				class376 var8 = this.method5856();
				if (null != var8) {
					var3 |= var2.method5564(var8);
					var3 |= this.method5893(var2);
					var3 |= var2.method5739(var4, var5);
					var3 |= var2.method5584(var6, var7);
				}
			} else if (var2.method5699()) {
				var3 |= this.method5893(var2);
			}
