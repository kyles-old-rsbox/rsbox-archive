public class class35 {
   ...
   int field232;
   int field233;
   int[] field224 = new int[2];
   int[] field229 = new int[2];
   ...
   final void method657(class460 var1) {
      this.field228 = var1.method8134();
      this.field226 = var1.method8119();
      this.field227 = var1.method8119();
      this.method663(var1);
   }

   final void method663(class460 var1) {
      this.field225 = var1.method8134();
      this.field224 = new int[this.field225];
      this.field229 = new int[this.field225];

      for(int var2 = 0; var2 < this.field225; ++var2) {
         this.field224[var2] = var1.method8115();
         this.field229[var2] = var1.method8115();
      }
