public class class153 extends class140 {
   ...
   void method2467(class460 var1) {
      this.field1412 = var1.method8115();
      this.field1413 = var1.method8134() == 1;
   }
   ...
   static int method2594(int var0, class78 var1, boolean var2) {
      ...
      if (3400 == var0) {
         ...
         if ('s' != var11.field2030) {
         }

         for(var7 = 0; var7 < var11.field2033; ++var7) {
            if (var5 == var11.field2036[var7]) {
               class57.field405[++class126.field1220 - 1] = var11.field2027[var7];
               var11 = null;
               break;
            }
         }
         ...
         if (var11 != null) {
            class57.field405[++class126.field1220 - 1] = var11.field2031;
         }
         ...
         if (3411 == var0) {
            var4 = class57.field404[--class387.field4452];
            class192 var10 = class175.method2755(var4);
            class57.field404[++class387.field4452 - 1] = var10.method3548();
            return 1;
         } else {
            return 2;
         }
         ...
         var4 = class57.field404[class387.field4452];
         var5 = class57.field404[class387.field4452 + 1];
         int var6 = class57.field404[2 + class387.field4452];
         var7 = class57.field404[class387.field4452 + 3];
         class192 var8 = class175.method2755(var6);
