public class class144 extends class140 {
	...
	static float method2499(class106 var0, float var1) {
		if (var0 != null && var0.method2055() != 0) {
			if (var1 < (float)var0.field1061[0].field1153) {
				return class118.field1141 == var0.field1058 ? var0.field1061[0].field1150 : class394.method7170(var0, var1, true);
			} else if (var1 > (float)var0.field1061[var0.method2055() - 1].field1153) {
				return var0.field1057 == class118.field1141 ? var0.field1061[var0.method2055() - 1].field1150 : class394.method7170(var0, var1, false);
							...
							if (var0.field1049) {
								if (null != var0) {
									...
									if ((double)var8 != 0.0D) {
										...
										float var27 = var11;
										float var28 = var12;
										float[] var29 = var0.field1055;
										float var18 = var27 - 0.0F;
										float var19 = var28 - var27;
										float var20 = 1.0F - var28;
										float var21 = var19 - var18;
										var29[3] = var20 - var19 - var21;
										var29[2] = var21 + var21 + var21;
										var29[1] = var18 + var18 + var18;
										var29[0] = 0.0F;
										var18 = var7[0];
										var19 = var7[1];
										var20 = var7[2];
	...
	void method2467(class460 var1) {
		this.field1326 = var1.method8122();
		this.field1328 = var1.method8126();
