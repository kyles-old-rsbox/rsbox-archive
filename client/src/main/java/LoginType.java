public class LoginType implements class273 {
	public static final LoginType RECONNECT;
	public static final LoginType field2976;
	public static final LoginType field2977;
	...
	static {
		...
		field2977 = new LoginType(19);
		field2978 = new LoginType(27);
		field2973 = new LoginType[32];
		LoginType[] var0 = new LoginType[]{RECONNECT, NORMAL, field2977, field2978, field2974, field2976};
		LoginType[] var1 = var0;
