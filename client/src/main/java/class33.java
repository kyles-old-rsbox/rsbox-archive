public class class33 {
   class59[] field211 = new class59[10];
   int field210;
   int field213;
   ...
   class33(class460 var1) {
      ...
      this.field210 = var1.method8115();
      this.field213 = var1.method8115();
   }

   public RawSound method605() {
      byte[] var1 = this.method607();
      return new RawSound(22050, var1, 22050 * this.field210 / 1000, 22050 * this.field213 / 1000);
   }
