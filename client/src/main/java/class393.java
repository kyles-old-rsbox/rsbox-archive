...
public abstract class class393 implements Comparator {
   ...
   final void method7152(Comparator var1) {
      if (null == this.field4487) {
         this.field4487 = var1;
      } else if (this.field4487 instanceof class393) {
         ((class393)this.field4487).method7152(var1);
      }

   }

   protected final int method7155(class400 var1, class400 var2) {
   ...
   public static class488 method7158(class319 var0, String var1, String var2) {
      int var4 = var0.method6116(var1);
      int var5 = var0.method6162(var4, var2);
      byte[] var8 = var0.method6167(var4, var5);
      boolean var7;
      if (var8 == null) {
         var7 = false;
      } else {
         class317.method6072(var8);
         var7 = true;
      }
   ...
   static int method7154(int var0, class78 var1, boolean var2) {
      if (var0 < 1000) {
         return class11.method84(var0, var1, var2);
      } else if (var0 < 1100) {
         return class323.method6194(var0, var1, var2);
      } else if (var0 < 1200) {
         return class445.method7929(var0, var1, var2);
      } else if (var0 < 1300) {
         return class100.method1986(var0, var1, var2);
      } else if (var0 < 1400) {
         return class87.method1849(var0, var1, var2);
      } else if (var0 < 1500) {
         return class307.method6037(var0, var1, var2);
      } else if (var0 < 1600) {
         ...
         return class396.method7169(var0, var1, var2);
      } else if (var0 < 2700) {
         ...
         return class306.method6024(var0, var1, var2);
      } else if (var0 < 3700) {
         ...
         return class325.method6213(var0, var1, var2);
      } else if (var0 < 5100) {
         ...
         return class346.method6397(var0, var1, var2);
      } else if (var0 < 6800) {
         ...
         return class332.method6256(var0, var1, var2);
      } else if (var0 < 7300) {
