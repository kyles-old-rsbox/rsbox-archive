...
public final class class392 {
   static byte[] field4482 = new byte[520];
   class466 field4484 = null;
   class466 field4486 = null;
   int field4483 = 65000;
   int field4485;
   ...
   public byte[] method7137(int var1) {
      synchronized(this.field4486) {
         try {
            Object var10000;
            if (this.field4484.method8387() < (long)(6 + var1 * 6)) {
               var10000 = null;
               return (byte[])var10000;
            } else {
               this.field4484.method8386((long)(6 * var1));
               this.field4484.method8385(field4482, 0, 6);
               ...
               if (var4 < 0 || var4 > this.field4483) {
                  var10000 = null;
                  return (byte[])var10000;
               } else if (var5 <= 0 || (long)var5 > this.field4486.method8387() / 520L) {
                  var10000 = null;
                  return (byte[])var10000;
               } else {
                  ...
                  for(int var8 = 0; var7 < var4; ++var8) {
                     ...
                     this.field4486.method8386((long)var5 * 520L);
                     int var9 = var4 - var7;
                     int var10;
                     int var11;
                     int var12;
                     ...
                     if (var1 > 65535) {
                        ...
                        var14 = 10;
                        this.field4486.method8385(field4482, 0, var9 + var14);
                     ...
                     if (var12 < 0 || (long)var12 > this.field4486.method8387() / 520L) {
                        var10000 = null;
                        return (byte[])var10000;
                     }
   ...
   public boolean method7138(int var1, byte[] var2, int var3) {
      synchronized(this.field4486) {
         if (var3 >= 0 && var3 <= this.field4483) {
            boolean var6 = this.method7139(var1, var2, var3, true);
            if (!var6) {
               var6 = this.method7139(var1, var2, var3, false);
            }
   ...
   boolean method7139(int var1, byte[] var2, int var3, boolean var4) {
      synchronized(this.field4486) {
         try {
            int var7;
            boolean var10000;
            if (var4) {
               ...
               this.field4484.method8386((long)(var1 * 6));
               this.field4484.method8385(field4482, 0, 6);
               var7 = (field4482[5] & 255) + ((field4482[3] & 255) << 16) + ((field4482[4] & 255) << 8);
               if (var7 <= 0 || (long)var7 > this.field4486.method8387() / 520L) {
                  var10000 = false;
                  return var10000;
               }
            } else {
               var7 = (int)((this.field4486.method8387() + 519L) / 520L);
               if (var7 == 0) {
                  var7 = 1;
               }
            }
            ...
            this.field4484.method8386((long)(var1 * 6));
            this.field4484.method8391(field4482, 0, 6);
            int var8 = 0;
            int var9 = 0;
            ...
            while(true) {
               if (var8 < var3) {
                  label171: {
                     ...
                     int var11;
                     if (var4) {
                        this.field4486.method8386(520L * (long)var7);
                        int var12;
                        int var13;
                        if (var1 > 65535) {
                           try {
                              this.field4486.method8385(field4482, 0, 10);
                           ...
                           try {
                              this.field4486.method8385(field4482, 0, 8);
                        ...
                        if (var10 < 0 || (long)var10 > this.field4486.method8387() / 520L) {
                           var10000 = false;
                           return var10000;
                        }
                     }
                     ...
                     if (0 == var10) {
                        var4 = false;
                        var10 = (int)((this.field4486.method8387() + 519L) / 520L);
                        if (var10 == 0) {
                           ++var10;
                        }
                     ...
                     if (var1 > 65535) {
                        ...
                        this.field4486.method8386(520L * (long)var7);
                        this.field4486.method8391(field4482, 0, 10);
                        var11 = var3 - var8;
                        if (var11 > 510) {
                           var11 = 510;
                        }

                        this.field4486.method8391(var2, var8, var11);
                        var8 += var11;
                     } else {
                        if (var3 - var8 <= 512) {
                           var10 = 0;
                        ...
                        this.field4486.method8386((long)var7 * 520L);
                        this.field4486.method8391(field4482, 0, 8);
                        var11 = var3 - var8;
                        if (var11 > 512) {
                           var11 = 512;
                        }
