public class class244 extends class239 {
   ...
   void method4872(class460 var1) {
      ...
      if (var3 != class256.field2948.field2947) {
         ...
         super.field2815 = var1.method8134();
         super.field2813 = var1.method8134();
         super.field2821 = var1.method8115();
         super.field2809 = var1.method8115();
         this.field2857 = var1.method8134();
         this.field2855 = var1.method8134();
         super.field2810 = var1.method8115();
         super.field2811 = var1.method8115();
         this.field2856 = var1.method8134();
         this.field2854 = var1.method8134();
         super.field2814 = var1.method8133();
         super.field2820 = var1.method8133();
      }
   }
