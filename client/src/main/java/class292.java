public class class292 extends class427 {
	...
	class292(Buffer var1) {
		...
		Buffer var51 = new Buffer(this.field3366);
			...
			while (true) {
				while (true) {
					...
					if (var64 == 7) {
						...
						var51.writeByte(47);
						var51.writeByte(0);
						var51.method8105(var51.offset - var61);
						continue label220;
					}
	...
	void method5492() {
		if (this.field3367 == null) {
			this.field3367 = new NodeHashTable(16);
			int[] var1 = new int[16];
			int[] var2 = new int[16];
			var2[9] = 128;
			var1[9] = 128;
