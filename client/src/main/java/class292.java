public class class292 extends class427 {
   ...
   class292(class460 var1) {
      ...
      for(var29 = 0; var29 < var6; ++var29) {
         var28 = var28 + var1.method8134() & 127;
         if (var28 != 0 && var28 != 32) {
            if (var28 == 1) {
               ++var16;
            } else if (var28 == 33) {
      ...
      var51.method8234(1297377380);
      var51.method8234(6);
      var51.method8174(var2 > 1 ? 1 : 0);
      var51.method8174(var2);
      var51.method8174(var3);
      ...
      for(int var60 = 0; var60 < var2; ++var60) {
         ...
         while(true) {
            while(true) {
               int var63 = var1.method8228();
               var51.method8225(var63);
               int var64 = var1.field4881[var29++] & 255;
               boolean var65 = var64 != var62;
               var62 = var64 & 15;
               if (var64 == 7) {
                  if (var65) {
                     var51.method8097(255);
                  }

                  var51.method8097(47);
                  var51.method8097(0);
                  var51.method8098(var51.field4878 - var61);
                  continue label220;
               }
               ...
               if (var64 == 23) {
                  ...
                  var51.method8097(81);
                  var51.method8097(3);
                  var51.method8097(var1.field4881[var50++]);
                  var51.method8097(var1.field4881[var50++]);
                  var51.method8097(var1.field4881[var50++]);
               } else {
                  var52 ^= var64 >> 4;
                  if (var62 == 0) {
                     if (var65) {
                        var51.method8097(144 + var52);
                     }

                     var53 += var1.field4881[var37++];
                     var54 += var1.field4881[var38++];
                     var51.method8097(var53 & 127);
                     var51.method8097(var54 & 127);
                  } else if (var62 == 1) {
                     if (var65) {
                        var51.method8097(128 + var52);
                     }

                     var53 += var1.field4881[var37++];
                     var55 += var1.field4881[var40++];
                     var51.method8097(var53 & 127);
                     var51.method8097(var55 & 127);
                  } else if (var62 == 2) {
                     if (var65) {
                        var51.method8097(176 + var52);
                     }

                     var28 = var28 + var1.field4881[var15++] & 127;
                     var51.method8097(var28);
                     byte var66;
                     if (var28 != 0 && var28 != 32) {
                        if (var28 == 1) {
                     ...
                     var59[var28] = var67;
                     var51.method8097(var67 & 127);
                  } else if (var62 == 3) {
                     if (var65) {
                        var51.method8097(224 + var52);
                     }

                     var56 += var1.field4881[var45++];
                     var56 += var1.field4881[var33++] << 7;
                     var51.method8097(var56 & 127);
                     var51.method8097(var56 >> 7 & 127);
                  } else if (var62 == 4) {
                     if (var65) {
                        var51.method8097(208 + var52);
                     }

                     var57 += var1.field4881[var32++];
                     var51.method8097(var57 & 127);
                  } else if (var62 == 5) {
                     if (var65) {
                        var51.method8097(160 + var52);
                     }

                     var53 += var1.field4881[var37++];
                     var58 += var1.field4881[var31++];
                     var51.method8097(var53 & 127);
                     var51.method8097(var58 & 127);
                  } else {
                     if (var62 != 6) {
                        throw new RuntimeException();
                     }
                     ...
                     if (var65) {
                        var51.method8097(192 + var52);
                     }

                     var51.method8097(var1.field4881[var44++]);
                  }
               }
            }
         }
               ...
               while(var4.field3161[var6] == var7) {
                  ...
                  if (var9 == 144) {
                     ...
                     if (var12 > 0) {
                        ...
                        class440 var14 = (class440)this.field3367.get((long)var13);
                        if (var14 == null) {
                           var14 = new class440(new byte[128]);
                           this.field3367.put(var14, (long)var13);
                        }
