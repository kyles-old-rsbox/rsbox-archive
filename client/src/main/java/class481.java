public class class481 extends class437 {
   ...
   public static int field4998 = 0;
   public static int[] field4992;

   protected class481() {
   }

   public static void method8644(int[] var0, int var1, int var2) {
      field4992 = var0;
      field4993 = var1;
      field4994 = var2;
      method8646(0, 0, var1, var2);
   }
   ...
   public static void method8646(int var0, int var1, int var2, int var3) {
      if (var0 < 0) {
         var0 = 0;
      }
   ...
   public static void method8717(int var0, int var1, int var2, int var3) {
      if (field4997 < var0) {
         field4997 = var0;
      }
   ...
   public static void method8711(int[] var0) {
      var0[0] = field4997;
      var0[1] = field4995;
      var0[2] = field4996;
      var0[3] = field4998;
   ...
   public static void method8648(int[] var0) {
      field4997 = var0[0];
      field4995 = var0[1];
      field4996 = var0[2];
      field4998 = var0[3];
   ...
   static void method8650(int var0, int var1, int var2, int var3) {
      if (var2 == 0) {
         method8721(var0, var1, var3);
      } else {
         if (var2 < 0) {
            var2 = -var2;
         }
   ...
   public static void method8651(int var0, int var1, int var2, int var3, int var4) {
      if (var4 != 0) {
         if (var4 == 256) {
            method8650(var0, var1, var2, var3);
         } else {
            if (var2 < 0) {
               var2 = -var2;
            }
   ...
   public static void method8652(int var0, int var1, int var2, int var3, int var4, int var5) {
      if (var0 < field4997) {
         var2 -= field4997 - var0;
         var0 = field4997;
      }
   ...
   public static void method8653(int var0, int var1, int var2, int var3, int var4) {
      if (var0 < field4997) {
         var2 -= field4997 - var0;
         var0 = field4997;
      }
   ...
   public static void method8679(int var0, int var1, int var2, int var3, int var4, int var5) {
      if (var2 > 0 && var3 > 0) {
         int var6 = 0;
         int var7 = 65536 / var3;
         if (var0 < field4997) {
   ...
   public static void method8678(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if (var2 > 0 && var3 > 0) {
         int var8 = 0;
         int var9 = 65536 / var3;
         if (var0 < field4997) {
   ...
   public static void method8654(int var0, int var1, int var2, int var3, int var4, int var5, byte[] var6, int var7, boolean var8) {
   ...
   public static void method8657(int var0, int var1, int var2, int var3, int var4) {
      method8659(var0, var1, var2, var4);
      method8659(var0, var1 + var3 - 1, var2, var4);
      method8660(var0, var1, var3, var4);
      method8660(var0 + var2 - 1, var1, var3, var4);
   }

   public static void method8661(int var0, int var1, int var2, int var3, int var4, int var5) {
      method8690(var0, var1, var2, var4, var5);
      method8690(var0, var1 + var3 - 1, var2, var4, var5);
      if (var3 >= 3) {
         method8662(var0, var1 + 1, var3 - 2, var4, var5);
         method8662(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5);
      }

   }

   public static void method8659(int var0, int var1, int var2, int var3) {
   ...
   static void method8690(int var0, int var1, int var2, int var3, int var4) {
      if (var1 >= field4995 && var1 < field4998) {
         if (var0 < field4997) {
            var2 -= field4997 - var0;
            var0 = field4997;
   ...
   public static void method8660(int var0, int var1, int var2, int var3) {
   ...
   static void method8662(int var0, int var1, int var2, int var3, int var4) {
      if (var0 >= field4997 && var0 < field4996) {
         if (var1 < field4995) {
            var2 -= field4995 - var1;
            var1 = field4995;
   ...
   public static void method8663(int var0, int var1, int var2, int var3, int var4) {
      var2 -= var0;
      var3 -= var1;
      if (var3 == 0) {
         if (var2 >= 0) {
            method8659(var0, var1, var2 + 1, var4);
         } else {
            method8659(var0 + var2, var1, -var2 + 1, var4);
         }

      } else if (var2 == 0) {
         if (var3 >= 0) {
            method8660(var0, var1, var3 + 1, var4);
         } else {
            method8660(var0, var1 + var3, -var3 + 1, var4);
         }
   ...
   static void method8721(int var0, int var1, int var2) {
      if (var0 >= field4997 && var1 >= field4995 && var0 < field4996 && var1 < field4998) {
         field4992[var0 + var1 * field4993] = var2;
      }
   }

   public static void method8706(int var0, int var1, int var2, int[] var3, int[] var4) {
