public class class67 {
   ...
   static float[][] field544 = new float[2][8];
   static int field540;
   static int[][] field545 = new int[2][8];
   int[] field543 = new int[2];
   int[] field550 = new int[2];
   int[][][] field541 = new int[2][2][4];
   int[][][] field542 = new int[2][2][4];
   ...
   final void method1397(class460 var1, class35 var2) {
      ...
      if (var3 != 0) {
         this.field543[0] = var1.method8115();
         this.field543[1] = var1.method8115();
         ...
         for(var5 = 0; var5 < 2; ++var5) {
            for(var6 = 0; var6 < this.field550[var5]; ++var6) {
               this.field541[var5][0][var6] = var1.method8115();
               this.field542[var5][0][var6] = var1.method8115();
            }
         }
         ...
         for(var5 = 0; var5 < 2; ++var5) {
            for(var6 = 0; var6 < this.field550[var5]; ++var6) {
               if ((var4 & 1 << var5 * 4 << var6) != 0) {
                  this.field541[var5][1][var6] = var1.method8115();
                  this.field542[var5][1][var6] = var1.method8115();
               } else {
