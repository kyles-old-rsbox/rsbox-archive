public class class148 {
	...
	public Integer method2569(int var1) {
		if (null == this.field1382) {
			...
			class427 var3 = this.field1382.method7788((long)var1);
	...
	boolean method2565(int var1, int var2) {
		if (this.field1382 != null) {
			class427 var4 = this.field1382.method7788((long)var1);
			if (var4 != null) {
		...
		this.field1382.method7781(new class426(var2), (long)var1);
		return true;
	}
	...
	boolean method2539(int var1, int var2, int var3, int var4) {
		...
		var2 &= var8;
		if (null != this.field1382) {
			class427 var9 = this.field1382.method7788((long)var1);
			if (var9 != null) {
	...
	boolean method2540(int var1, long var2) {
		...
		this.field1382.method7781(new class424(var2), (long)var1);
		return true;
	}
	...
	boolean method2541(int var1, String var2) {
			...
			if (null != var4) {
				if (var4 instanceof class418) {
					...
					if (var5.field4601 instanceof String) {
						...
						var5.method7825();
						this.field1382.method7781(new class418(var2), var5.field4681);
						return true;
					}
				}
		...
		this.field1382.method7781(new class418(var2), (long)var1);
		return true;
	}
		...
		if (var3 >= 1 && var3 <= 6) {
			...
			if (this.field1378 > 0) {
				...
				for (var5 = 0; var5 < this.field1378; ++var5) {
					...
					if (this.field1359) {
						this.field1371[var5] = var1.method8305();
					}
				}
			}
