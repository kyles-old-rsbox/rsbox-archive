public class class191 {
   ...
   public static int[] field2017 = new int[4096];
   public static int[] field2021 = new int[4096];
   public static int[][] field2020 = new int[128][128];
   public static int[][] field2023 = new int[128][128];
   ...
   public static class187 method3536(int var0) {
      ...
      if (null != var2) {
         ...
         byte[] var3 = class187.field1978.method6167(34, var0);
         var2 = new class187();
         if (null != var3) {
   ...
   static int method3535(int var0, class78 var1, boolean var2) {
      ...
      if (1700 == var0) {
         ...
         class57.field404[++class387.field4452 - 1] = var4.method5868() ? 1 : 0;
         return 1;
      } else if (1708 == var0) {
         return class405.method7361(var4);
      } else {
