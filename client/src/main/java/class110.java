...
public class class110 {
   ...
   static int field1091 = 0;
   static final class355 field1088 = new class355();
   static final class421 field1089 = new class421(1024);
   static final Map field1093 = new HashMap();

   class110() throws Throwable {
      throw new Error();
   }

   static int method7839() {
      return ++field1091 - 1;
   }
   ...
   static void method1858(int var0, String var1, String var2, String var3) {
      ...
      field1089.method7774(var6, (long)var6.field496);
      field1088.method6592(var6);
      client.field1843 = client.field1878;
   }

   static class63 method6305(int var0, int var1) {
      class71 var3 = (class71)field1093.get(var0);
      return var3.method1428(var1);
   }

   static class63 method204(int var0) {
      return (class63)field1089.method7781((long)var0);
   }
}
