...
public abstract class class401 {
   ...
   static void method7263(class189 var0, int var1, int var2, int var3) {
   ...
   public abstract boolean method7247(int var1) throws IOException;

   public abstract int method7248() throws IOException;

   public abstract int method7249() throws IOException;

   public abstract void method7251(byte[] var1, int var2, int var3) throws IOException;

   public abstract void method7252();

   public abstract int method7260(byte[] var1, int var2, int var3) throws IOException;
}
