public class class299 extends class51 {
   ...
   class278 field3443;
   class343 field3440 = new class343();
   class38 field3441 = new class38();
   ...
   protected class51 method1007() {
      class296 var1 = (class296)this.field3440.method6356();
      if (var1 == null) {
         return null;
      } else {
   ...
   protected class51 method1004() {
      class296 var1;
      do {
         var1 = (class296)this.field3440.method6350();
         if (null == var1) {
            return null;
         }
   ...
   protected void method1005(int[] var1, int var2, int var3) {
      ...
      for(class296 var6 = (class296)this.field3440.method6356(); var6 != null; var6 = (class296)this.field3440.method6350()) {
         if (!this.field3443.method5300(var6)) {
            ...
            do {
               if (var5 <= var6.field3398) {
                  this.method5830(var6, var1, var4, var5, var4 + var5);
                  var6.field3398 -= var5;
                  break;
               }

               this.method5830(var6, var1, var4, var6.field3398, var4 + var5);
               var4 += var6.field3398;
               var5 -= var6.field3398;
   ...
   protected void method1001(int var1) {
      ...
      for(class296 var3 = (class296)this.field3440.method6356(); null != var3; var3 = (class296)this.field3440.method6350()) {
         if (!this.field3443.method5300(var3)) {
            int var2 = var1;

            do {
               if (var2 <= var3.field3398) {
                  this.method5836(var3, var2);
                  var3.field3398 -= var2;
                  break;
               }

               this.method5836(var3, var3.field3398);
               var2 -= var3.field3398;
   ...
   void method5830(class296 var1, int[] var2, int var3, int var4, int var5) {
      if ((this.field3443.field3181[var1.field3381] & 4) != 0 && var1.field3393 < 0) {
         int var7 = this.field3443.field3186[var1.field3381] / SoundCache.field348;
         ...
         while(true) {
            ...
            int var9 = SoundCache.field348 / 100;
   ...
   void method5836(class296 var1, int var2) {
      if (0 != (this.field3443.field3181[var1.field3381] & 4) && var1.field3393 < 0) {
         int var4 = this.field3443.field3186[var1.field3381] / SoundCache.field348;
