...
public class class420 {
   ...
   boolean field4632 = false;
   boolean field4643 = true;
   boolean field4649 = false;
   class246 field4618;
   class254 field4615;
   class254 field4616;
   class254 field4617;
   class295 field4654 = null;
   class319 field4607;
   class319 field4609;
   class319 field4662;
   class376 field4611;
   ...
   HashMap field4612;
   HashMap field4614;
   HashSet field4606 = new HashSet();
   HashSet field4633 = null;
   HashSet field4644 = new HashSet();
   HashSet field4645 = new HashSet();
   HashSet field4646 = new HashSet();
   HashSet field4647 = new HashSet();
   Iterator field4652;
   List field4648;
   long field4640;
   final int[] field4636 = new int[]{1008, 1009, 1010, 1011, 1012};
   ...
   public void method7734(class319 var1, class319 var2, class319 var3, class376 var4, HashMap var5, class488[] var6) {
      this.field4613 = var6;
      this.field4609 = var1;
      this.field4662 = var2;
      this.field4607 = var3;
      ...
      int var8 = this.field4609.method6116(class242.field2838.field2837);
      int[] var9 = this.field4609.method6090(var8);
      this.field4614 = new HashMap(var9.length);

      for(int var10 = 0; var10 < var9.length; ++var10) {
         class460 var11 = new class460(this.field4609.method6167(var8, var9[var10]));
      ...
      this.method7570(this.field4615);
      this.field4617 = null;
   }
   ...
   public void method7650(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
      if (this.field4619.method7867()) {
         this.method7572();
         this.method7730();
         if (var3) {
   ...
   public void method7735(int var1, int var2, boolean var3, boolean var4) {
      long var6 = class272.method2046();
      this.method7657(var1, var2, var4, var6);
      if (!this.method7727() && (var4 || var3) && !client.method5834()) {
         if (var4) {
            this.field4638 = var1;
            this.field4624 = var2;
         ...
         if (-1 != this.field4631) {
            ...
            this.method7574(this.field4631 - (int)((float)var8 / this.field4625), this.field4637 + (int)((float)var9 / this.field4625), false);
         }
      } else {
         this.method7575();
      }
   ...
   void method7657(int var1, int var2, boolean var3, long var4) {
      if (this.field4616 != null) {
         int var6 = (int)((float)this.field4634 + ((float)(var1 - this.field4623) - (float)this.method7604() * this.field4650 / 2.0F) / this.field4650);
         int var7 = (int)((float)this.field4622 - ((float)(var2 - this.field4629) - (float)this.method7605() * this.field4650 / 2.0F) / this.field4650);
         ...
         if (this.field4654 != null && var3) {
            ...
            if (class114.method2218() && var8.method3895(82) && var8.method3895(81)) {
               ...
               if (var10) {
                  ...
                  var13.field2984.method8234(this.field4654.method5522());
   ...
   void method7730() {
      if (this.method7727()) {
         ...
         this.method7574(this.field4634 + var2, this.field4622 + var3, true);
   ...
   final void method7574(int var1, int var2, boolean var3) {
      this.field4634 = var1;
      this.field4622 = var2;
      class272.method2046();
      if (var3) {
   ...
   public class254 method7707(int var1, int var2, int var3) {
   ...
   public void method7590(int var1, int var2, int var3, boolean var4) {
      class254 var6 = this.method7707(var1, var2, var3);
      if (var6 == null) {
         if (!var4) {
            return;
         }
      ...
      if (this.field4617 != var6 || var4) {
         this.field4617 = var6;
         this.method7570(var6);
         var7 = true;
      }

      if (var7 || var4) {
         this.method7756(var1, var2, var3);
      }

   }

   public void method7609(int var1) {
      class254 var3 = this.method7596(var1);
      if (null != var3) {
         this.method7570(var3);
      }
   ...
   public class254 method7581() {
      return this.field4616;
   }

   void method7570(class254 var1) {
      if (this.field4616 == null || this.field4616 != var1) {
         this.method7585(var1);
         this.method7756(-1, -1, -1);
      }
   }

   void method7585(class254 var1) {
      this.field4616 = var1;
      this.field4618 = new class246(this.field4613, this.field4612, this.field4662, this.field4607);
      this.field4619.method7865(this.field4616.method5054());
   }

   public void method7584(class254 var1, class295 var2, class295 var3, boolean var4) {
      if (null != var1) {
         ...
         if (!var4 && this.field4616.method5083(var2.field3374, var2.field3376, var2.field3375)) {
            this.method7756(var2.field3374, var2.field3376, var2.field3375);
         } else {
            this.method7756(var3.field3374, var3.field3376, var3.field3375);
         }

      }
   }

   void method7756(int var1, int var2, int var3) {
      if (this.field4616 != null) {
         ...
         this.method7574(var5[0] - this.field4616.method5124() * 64, var5[1] - this.field4616.method5079() * 64, true);
         this.field4608 = -1;
         this.field4659 = -1;
         this.field4650 = this.method7761(this.field4616.method5057());
   ...
   public void method7656(int var1, int var2, int var3, int var4, int var5) {
      int[] var7 = new int[4];
      class481.method8711(var7);
      class481.method8646(var1, var2, var3 + var1, var2 + var4);
      class481.method8653(var1, var2, var3, var4, -16777216);
      int var8 = this.field4619.method7864();
      if (var8 < 100) {
         this.method7655(var1, var2, var3, var4, var8);
      } else {
         ...
         this.method7588(var1, var2, var3, var4, var9, var10);
         if (class114.method2218() && this.field4655 && this.field4654 != null) {
            this.field4611.method6868("Coord: " + this.field4654, class481.field4997 + 10, 20 + class481.field4995, 16776960, -1);
         }
         ...
         this.field4623 = var1;
         this.field4629 = var2;
         class481.method8648(var7);
      }
   }

   boolean method7587(int var1, int var2, int var3, int var4, int var5, int var6) {
   ...
   void method7588(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (class335.field3867 != null) {
         ...
         int var12 = this.method7601() - var5 / 2 - var8;
         int var13 = this.method7602() - var6 / 2 - var8;
         ...
         if (this.method7587(var9, var10, var14, var15, var3, var4)) {
            ...
            this.field4658 = this.method7601() - var5 / 2 - var8;
            this.field4620 = this.method7602() - var6 / 2 - var8;
            this.field4651 = this.field4618.field2875;
            class335.field3867.method6421(this.field4658, this.field4620, this.field4656, (float)this.field4651 / var11);
         ...
         class481.method8652(var1, var2, var3, var4, 0, 128);
         if (var11 == 1.0F) {
            this.field4656.method8488(var14, var15, 192);
         } else {
            this.field4656.method8491(var14, var15, (int)((float)var9 * var11), (int)(var11 * (float)var10), 192);
         }
      }

   }

   public void method7589(int var1, int var2, int var3, int var4) {
      if (this.field4619.method7867()) {
         if (!this.field4618.method4900()) {
            this.field4618.method4892(this.field4609, this.field4616.method5054(), client.field1635);
            if (!this.field4618.method4900()) {
   ...
   public void method7578(int var1) {
      this.field4625 = this.method7761(var1);
   }

   void method7655(int var1, int var2, int var3, int var4, int var5) {
      byte var7 = 20;
      int var8 = var1 + var3 / 2;
      int var9 = var4 / 2 + var2 - 18 - var7;
      class481.method8653(var1, var2, var3, var4, -16777216);
      class481.method8657(var8 - 152, var9, 304, 34, -65536);
      class481.method8653(var8 - 150, var9 + 2, 3 * var5, 30, -65536);
      this.field4611.method6948(class338.field3961, var8, var9 + var7, -1, -1);
   }

   float method7761(int var1) {
      if (var1 == 25) {
         return 1.0F;
      } else if (var1 == 37) {
         return 1.5F;
   ...
   public void method7594() {
      this.field4619.method7866();
   }

   public boolean method7595() {
      return this.field4619.method7867();
   }

   public class254 method7596(int var1) {
   ...
   public void method7597(int var1, int var2) {
   ...
   public void method7598(int var1, int var2) {
      if (this.field4616 != null) {
         this.method7574(var1 - this.field4616.method5124() * 64, var2 - this.field4616.method5079() * 64, true);
         this.field4608 = -1;
         this.field4659 = -1;
      }
   }

   public void method7599(int var1, int var2, int var3) {
      if (this.field4616 != null) {
         int[] var5 = this.field4616.method5049(var1, var2, var3);
         if (null != var5) {
            this.method7597(var5[0], var5[1]);
         }

      }
   }

   public void method7600(int var1, int var2, int var3) {
      if (null != this.field4616) {
         int[] var5 = this.field4616.method5049(var1, var2, var3);
         if (null != var5) {
            this.method7598(var5[0], var5[1]);
         }
   ...
   public class295 method7603() {
      return this.field4616 == null ? null : this.field4616.method5100(this.method7601(), this.method7602());
   }
   ...
   public void method7608(int var1) {
      if (var1 >= 1) {
         this.field4621 = var1;
      }
   ...
   public void method7700(boolean var1) {
      this.field4632 = var1;
   }

   public void method7758(int var1) {
   ...
   public void method7724(int var1) {
      this.field4633 = new HashSet();
      this.field4603 = 0;
      this.field4635 = 0;
   ...
   public void method7614(boolean var1) {
      this.field4649 = !var1;
   }

   public void method7615(int var1, boolean var2) {
      if (!var2) {
   ...
   public void method7616(int var1, boolean var2) {
      if (!var2) {
   ...
   public boolean method7618(int var1) {
   ...
   public void method7621(int var1, int var2, int var3, int var4, int var5, int var6) {
      if (this.field4619.method7867()) {
   ...
   public class295 method7622(int var1, class295 var2) {
      if (!this.field4619.method7867()) {
         return null;
   ...
   public void method7623(int var1, int var2, class295 var3, class295 var4) {
   ...
   public class251 method7624() {
      if (!this.field4619.method7867()) {
         ...
         return this.method7711();
      }
   }

   public class251 method7711() {
